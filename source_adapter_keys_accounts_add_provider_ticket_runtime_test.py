...
package = example_source_adapter_keys_accounts_add_provider_ticket_runtime_package()
...
verification = verify_source_adapter_keys_accounts_add_provider_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter KEYS Accounts Add Provider Ticket Runtime self-test passed.")
