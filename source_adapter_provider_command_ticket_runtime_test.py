...
package = example_source_adapter_provider_command_ticket_runtime_package()
...
verification = verify_source_adapter_provider_command_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter Provider Command Ticket Runtime self-test passed.")
