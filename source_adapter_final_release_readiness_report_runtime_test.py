...
verification = verify_source_adapter_final_release_readiness_report_runtime(package)
assert verification["verified"], verification
print("Source Adapter Final Release Readiness Report Runtime self-test passed.")
