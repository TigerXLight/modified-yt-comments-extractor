...
from source_adapter_release_operator_signoff_receipt_runtime import RUNTIME_STAGE, ReleaseOperatorSignoffReceiptRecord


def verify_record(record: ReleaseOperatorSignoffReceiptRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[ReleaseOperatorSignoffReceiptRecord]) -> list[str]:
    issues: list[str] = []
