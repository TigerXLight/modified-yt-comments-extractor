...
from source_adapter_operator_signoff_acceptance_gate_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Operator Signoff Acceptance Gate Runtime CLI self-test passed.")
