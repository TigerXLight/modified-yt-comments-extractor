from source_adapter_final_source_evidence_acceptance_pack_runtime import build_record
from source_adapter_final_source_evidence_acceptance_pack_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter Final Source Evidence Acceptance Pack Runtime store self-test passed.")
