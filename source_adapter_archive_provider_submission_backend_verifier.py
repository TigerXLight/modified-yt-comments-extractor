...
SCHEMA_VERSION = "source_adapter_archive_provider_submission_backend_verifier_v1"


def verify_source_adapter_archive_provider_submission_backend_package(package: Mapping[str, Any]) -> dict[str, Any]:
...
def main() -> None:
    print(json.dumps(verify_source_adapter_archive_provider_submission_backend_package(example_archive_provider_submission_backend_package()), indent=2, sort_keys=True))
