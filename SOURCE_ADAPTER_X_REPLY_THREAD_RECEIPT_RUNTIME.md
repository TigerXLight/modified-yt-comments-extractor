# Source Adapter X Reply Thread Receipt Runtime

This slice records the **X Reply Thread Receipt** stage for the shared Source Adapter / Total Export / Source Evidence roadmap.
...
- a stable runtime stage identifier: `x_reply_thread_receipt`;
