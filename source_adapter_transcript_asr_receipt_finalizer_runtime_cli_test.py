...
from source_adapter_transcript_asr_receipt_finalizer_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Transcript ASR Receipt Finalizer Runtime CLI self-test passed.")
