from source_adapter_asr_handoff_source_linker_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_asr_handoff_source_linker_runtime_package
...
verification = verify_source_adapter_asr_handoff_source_linker_runtime(package)
assert verification["verified"], verification
print("Source Adapter ASR Handoff Source Linker Runtime self-test passed.")
