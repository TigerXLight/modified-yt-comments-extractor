...
from source_adapter_release_final_integrity_check_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Release Final Integrity Check Runtime CLI self-test passed.")
