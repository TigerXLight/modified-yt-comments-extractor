...
from source_adapter_local_asr_large_v3_vulkan_profile_runtime import build_default_record, build_record, render_record_text
from source_adapter_local_asr_large_v3_vulkan_profile_runtime_store import RuntimeStore
from source_adapter_local_asr_large_v3_vulkan_profile_runtime_verifier import verify_record, verify_records


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Local ASR Large V3 Vulkan Profile runtime helper")
    parser.add_argument("--runtime-id", default="local_asr_large_v3_vulkan_profile-cli")
...
def main(argv: list[str] | None = None) -> int:
    ...
    record = build_record(
        ...
        metadata={"runtime_title": "Local ASR Large V3 Vulkan Profile"},
    )
