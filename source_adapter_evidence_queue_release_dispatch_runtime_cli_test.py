...
from source_adapter_evidence_queue_release_dispatch_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Evidence Queue Release Dispatch Runtime CLI self-test passed.")
