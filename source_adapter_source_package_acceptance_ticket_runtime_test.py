...
package = example_source_adapter_source_package_acceptance_ticket_runtime_package()
...
verification = verify_source_adapter_source_package_acceptance_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter Source Package Acceptance Ticket Runtime self-test passed.")
