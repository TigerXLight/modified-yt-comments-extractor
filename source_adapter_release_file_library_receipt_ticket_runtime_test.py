...
verification = verify_source_adapter_release_file_library_receipt_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter Release File Library Receipt Ticket Runtime self-test passed.")
