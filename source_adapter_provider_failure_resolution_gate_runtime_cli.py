...
from source_adapter_provider_failure_resolution_gate_runtime import build_default_record, build_record, render_record_text
from source_adapter_provider_failure_resolution_gate_runtime_store import RuntimeStore
from source_adapter_provider_failure_resolution_gate_runtime_verifier import verify_record, verify_records


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Provider Failure Resolution Gate runtime helper")
    parser.add_argument("--runtime-id", default="provider_failure_resolution_gate-cli")
...
def main(argv: list[str] | None = None) -> int:
    ...
    record = build_record(
        ...
        metadata={"runtime_title": "Provider Failure Resolution Gate"},
    )
