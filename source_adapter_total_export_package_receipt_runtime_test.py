from source_adapter_total_export_package_receipt_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "total_export_package_receipt"
...
if __name__ == "__main__":
    ...
    print("Source Adapter Total Export Package Receipt Runtime self-test passed.")
