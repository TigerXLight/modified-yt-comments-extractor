...
with tempfile.TemporaryDirectory() as tmp:
    result = store_source_adapter_capture_comment_receipt_mapper_runtime_package(example_source_adapter_capture_comment_receipt_mapper_runtime_package(), tmp)
...
print("Source Adapter Capture Comment Receipt Mapper Runtime store self-test passed.")
