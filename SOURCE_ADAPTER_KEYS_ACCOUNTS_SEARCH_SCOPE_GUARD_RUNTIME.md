# Source Adapter KEYS Accounts Search Scope Guard Runtime

This slice records the **KEYS Accounts Search Scope Guard** stage for the shared Source Adapter / Total Export / Source Evidence roadmap.
...
- a stable runtime stage identifier: `keys_accounts_search_scope_guard`;
