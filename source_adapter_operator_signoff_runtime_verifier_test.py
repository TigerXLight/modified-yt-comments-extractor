...
v = verify_source_adapter_operator_signoff_runtime_package(example_source_adapter_operator_signoff_runtime_package())
assert v["verified"], v
assert v["issue_count"] == 0, v
print("Source Adapter Operator Signoff Runtime verifier self-test passed.")
