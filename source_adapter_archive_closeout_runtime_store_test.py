...
with tempfile.TemporaryDirectory() as tmp:
    result = store_source_adapter_archive_closeout_runtime_package(example_source_adapter_archive_closeout_runtime_package(), tmp)
...
print("Source Adapter Archive Closeout Runtime store self-test passed.")
