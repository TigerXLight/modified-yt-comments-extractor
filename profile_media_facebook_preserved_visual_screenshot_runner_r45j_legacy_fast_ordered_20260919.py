...
import profile_media_facebook_bounded_modal_capture_runner_r45h_legacy_fast_ordered_20260919 as r45h
...
def run_live(args: argparse.Namespace) -> Dict[str, Any]:
    ...
    with sync_playwright() as p:
        ...
        if args.auto_expand:
            ...
            try:
                print(f'R45AI_LEGACY_FAST_ORDERED_AUTO_EXPAND_START max_seconds={args.expand_max_seconds}')
                auto_expand_summary = page.evaluate(r45h.JS_BOUNDED_MODAL_AUTO_EXPAND, opts)
                print('R45AI_LEGACY_FAST_ORDERED_AUTO_EXPAND_DONE')
            except Exception as e:
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    ap.description = 'R45AI Facebook preserved visual screenshot runner: legacy 2026-09-19 engine, fast top-to-bottom visible order'
    ap.set_defaults(output_root='profile_media_live_captures/r45ai_legacy_fast_ordered_20260919')
