...
from source_adapter_final_source_evidence_acceptance_pack_runtime import build_default_record, build_record, render_record_text
from source_adapter_final_source_evidence_acceptance_pack_runtime_store import RuntimeStore
from source_adapter_final_source_evidence_acceptance_pack_runtime_verifier import verify_record, verify_records


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Final Source Evidence Acceptance Pack runtime helper")
    parser.add_argument("--runtime-id", default="final_source_evidence_acceptance_pack-cli")
...
def main(argv: list[str] | None = None) -> int:
    ...
    record = build_record(
        ...
        metadata={"runtime_title": "Final Source Evidence Acceptance Pack"},
    )
