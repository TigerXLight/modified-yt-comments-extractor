...
package = example_source_adapter_youtube_comment_source_ticket_runtime_package()
...
verification = verify_source_adapter_youtube_comment_source_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter YouTube Comment Source Ticket Runtime self-test passed.")
