...
from source_adapter_traceability_final_crosscheck_runtime import build_default_record, build_record, render_record_text
from source_adapter_traceability_final_crosscheck_runtime_store import RuntimeStore
from source_adapter_traceability_final_crosscheck_runtime_verifier import verify_record, verify_records


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Traceability Final Crosscheck runtime helper")
    parser.add_argument("--runtime-id", default="traceability_final_crosscheck-cli")
...
def main(argv: list[str] | None = None) -> int:
    ...
    record = build_record(
        ...
        metadata={"runtime_title": "Traceability Final Crosscheck"},
    )
