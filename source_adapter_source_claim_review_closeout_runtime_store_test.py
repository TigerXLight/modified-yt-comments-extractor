from source_adapter_source_claim_review_closeout_runtime import build_record
from source_adapter_source_claim_review_closeout_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter Source Claim Review Closeout Runtime store self-test passed.")
