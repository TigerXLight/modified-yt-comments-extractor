...
from source_adapter_msn_article_capture_receipt_runtime import build_default_record, build_record, render_record_text
from source_adapter_msn_article_capture_receipt_runtime_store import RuntimeStore
from source_adapter_msn_article_capture_receipt_runtime_verifier import verify_record, verify_records


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="MSN Article Capture Receipt runtime helper")
    parser.add_argument("--runtime-id", default="msn_article_capture_receipt-cli")
...
def main(argv: list[str] | None = None) -> int:
    ...
    record = build_record(
        ...
        metadata={"runtime_title": "MSN Article Capture Receipt"},
    )
