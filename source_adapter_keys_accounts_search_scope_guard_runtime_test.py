from source_adapter_keys_accounts_search_scope_guard_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "keys_accounts_search_scope_guard"
...
if __name__ == "__main__":
    ...
    print("Source Adapter KEYS Accounts Search Scope Guard Runtime self-test passed.")
