...
with tempfile.TemporaryDirectory() as tmp:
    result = store_source_adapter_release_lock_runtime_package(example_source_adapter_release_lock_runtime_package(), tmp)
...
print("Source Adapter Release Lock Runtime store self-test passed.")
