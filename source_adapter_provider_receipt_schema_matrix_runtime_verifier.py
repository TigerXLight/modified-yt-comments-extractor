...
def verify_source_adapter_provider_receipt_schema_matrix_runtime(package: Mapping[str, Any] | None = None) -> dict[str, Any]:
    ...
    return {
        "schema_version": "source_adapter_provider_receipt_schema_matrix_runtime_verification_v1",
        "verified": not issues,
...
if __name__ == "__main__":
    print(json.dumps(verify_source_adapter_provider_receipt_schema_matrix_runtime(), indent=2, sort_keys=True))
