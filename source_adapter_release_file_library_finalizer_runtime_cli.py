...
from source_adapter_release_file_library_finalizer_runtime import build_default_record, build_record, render_record_text
from source_adapter_release_file_library_finalizer_runtime_store import RuntimeStore
from source_adapter_release_file_library_finalizer_runtime_verifier import verify_record, verify_records


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Release File Library Finalizer runtime helper")
    parser.add_argument("--runtime-id", default="release_file_library_finalizer-cli")
...
def main(argv: list[str] | None = None) -> int:
    ...
    record = build_record(
        ...
        metadata={"runtime_title": "Release File Library Finalizer"},
    )
