...
from source_adapter_gui_action_state_runtime import KEYS_ACCOUNTS_LABEL, STATUS, build_package


def test_gui_action_state_runtime() -> None:
...
if __name__ == "__main__":
    test_gui_action_state_runtime()
    print("Source Adapter GUI Action State Runtime self-test passed.")
