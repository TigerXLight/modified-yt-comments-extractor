...
with tempfile.TemporaryDirectory() as tmp:
    result = store_source_adapter_secret_scope_runtime_package(example_source_adapter_secret_scope_runtime_package(), tmp)
...
print("Source Adapter Secret Scope Runtime store self-test passed.")
