...
from source_adapter_keys_accounts_secret_boundary_receipt_runtime import RUNTIME_STAGE, KeysAccountsSecretBoundaryReceiptRecord


def verify_record(record: KeysAccountsSecretBoundaryReceiptRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[KeysAccountsSecretBoundaryReceiptRecord]) -> list[str]:
    issues: list[str] = []
