from source_adapter_evidence_queue_gui_bridge_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_evidence_queue_gui_bridge_runtime_package
...
verification = verify_source_adapter_evidence_queue_gui_bridge_runtime(package)
assert verification["verified"], verification
print("Source Adapter Evidence Queue GUI Bridge Runtime self-test passed.")
