...
from source_adapter_operator_approval_acceptance_gate_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Operator Approval Acceptance Gate Runtime CLI self-test passed.")
