from source_adapter_release_file_library_finalizer_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "release_file_library_finalizer"
...
if __name__ == "__main__":
    ...
    print("Source Adapter Release File Library Finalizer Runtime self-test passed.")
