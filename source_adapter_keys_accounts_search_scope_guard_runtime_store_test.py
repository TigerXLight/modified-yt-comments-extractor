from source_adapter_keys_accounts_search_scope_guard_runtime import build_record
from source_adapter_keys_accounts_search_scope_guard_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter KEYS Accounts Search Scope Guard Runtime store self-test passed.")
