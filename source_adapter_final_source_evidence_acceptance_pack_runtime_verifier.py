...
from source_adapter_final_source_evidence_acceptance_pack_runtime import RUNTIME_STAGE, FinalSourceEvidenceAcceptancePackRecord


def verify_record(record: FinalSourceEvidenceAcceptancePackRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[FinalSourceEvidenceAcceptancePackRecord]) -> list[str]:
    issues: list[str] = []
