...
from source_adapter_evidence_final_integrity_check_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Evidence Final Integrity Check Runtime CLI self-test passed.")
