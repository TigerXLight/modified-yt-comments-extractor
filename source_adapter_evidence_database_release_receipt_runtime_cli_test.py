...
from source_adapter_evidence_database_release_receipt_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Evidence Database Release Receipt Runtime CLI self-test passed.")
