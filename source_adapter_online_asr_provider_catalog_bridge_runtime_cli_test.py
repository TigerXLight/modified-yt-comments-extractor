...
from source_adapter_online_asr_provider_catalog_bridge_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Online ASR Provider Catalog Bridge Runtime CLI self-test passed.")
