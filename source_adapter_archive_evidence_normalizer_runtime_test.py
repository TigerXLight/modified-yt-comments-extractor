from source_adapter_archive_evidence_normalizer_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_archive_evidence_normalizer_runtime_package
...
verification = verify_source_adapter_archive_evidence_normalizer_runtime(package)
assert verification["verified"], verification
print("Source Adapter Archive Evidence Normalizer Runtime self-test passed.")
