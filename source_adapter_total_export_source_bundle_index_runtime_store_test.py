from source_adapter_total_export_source_bundle_index_runtime import build_record
from source_adapter_total_export_source_bundle_index_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter Total Export Source Bundle Index Runtime store self-test passed.")
