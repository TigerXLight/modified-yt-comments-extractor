...
from source_adapter_source_chain_acceptance_audit_runtime import RUNTIME_STAGE, SourceChainAcceptanceAuditRecord


def verify_record(record: SourceChainAcceptanceAuditRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[SourceChainAcceptanceAuditRecord]) -> list[str]:
    issues: list[str] = []
