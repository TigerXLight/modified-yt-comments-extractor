from source_adapter_keys_accounts_add_provider_receipt_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "keys_accounts_add_provider_receipt"
...
if __name__ == "__main__":
    ...
    print("Source Adapter KEYS Accounts Add Provider Receipt Runtime self-test passed.")
