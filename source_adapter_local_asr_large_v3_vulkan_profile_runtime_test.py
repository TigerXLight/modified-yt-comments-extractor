from source_adapter_local_asr_large_v3_vulkan_profile_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "local_asr_large_v3_vulkan_profile"
...
if __name__ == "__main__":
    ...
    print("Source Adapter Local ASR Large V3 Vulkan Profile Runtime self-test passed.")
