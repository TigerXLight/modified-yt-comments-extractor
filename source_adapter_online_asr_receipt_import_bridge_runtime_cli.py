...
from source_adapter_online_asr_receipt_import_bridge_runtime import build_default_record, build_record, render_record_text
from source_adapter_online_asr_receipt_import_bridge_runtime_store import RuntimeStore
from source_adapter_online_asr_receipt_import_bridge_runtime_verifier import verify_record, verify_records


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Online ASR Receipt Import Bridge runtime helper")
    parser.add_argument("--runtime-id", default="online_asr_receipt_import_bridge-cli")
...
def main(argv: list[str] | None = None) -> int:
    ...
    record = build_record(
        ...
        metadata={"runtime_title": "Online ASR Receipt Import Bridge"},
    )
