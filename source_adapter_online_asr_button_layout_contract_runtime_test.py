...
verification = verify_source_adapter_online_asr_button_layout_contract_runtime(package)
assert verification["verified"], verification
print("Source Adapter Online ASR Button Layout Contract Runtime self-test passed.")
