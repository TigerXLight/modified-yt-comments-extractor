...
with tempfile.TemporaryDirectory() as tmp:
    result = store_source_adapter_provider_retry_runtime_package(example_source_adapter_provider_retry_runtime_package(), tmp)
...
print("Source Adapter Provider Retry Runtime store self-test passed.")
