from source_adapter_x_post_archive_receipt_runtime import build_record
from source_adapter_x_post_archive_receipt_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter X Post Archive Receipt Runtime store self-test passed.")
