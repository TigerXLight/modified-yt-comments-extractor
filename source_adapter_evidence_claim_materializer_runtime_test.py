from source_adapter_evidence_claim_materializer_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_evidence_claim_materializer_runtime_package
...
verification = verify_source_adapter_evidence_claim_materializer_runtime(package)
assert verification["verified"], verification
print("Source Adapter Evidence Claim Materializer Runtime self-test passed.")
