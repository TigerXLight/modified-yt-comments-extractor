...
verification = verify_source_adapter_keys_accounts_provider_add_flow_runtime(package)
assert verification["verified"], verification
print("Source Adapter KEYS Accounts Provider Add Flow Runtime self-test passed.")
