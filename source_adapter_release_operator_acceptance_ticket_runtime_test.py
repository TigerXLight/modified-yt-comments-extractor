...
package = example_source_adapter_release_operator_acceptance_ticket_runtime_package()
...
verification = verify_source_adapter_release_operator_acceptance_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter Release Operator Acceptance Ticket Runtime self-test passed.")
