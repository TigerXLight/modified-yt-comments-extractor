...
from source_adapter_project_handoff_acceptance_audit_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Project Handoff Acceptance Audit Runtime CLI self-test passed.")
