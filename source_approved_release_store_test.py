...
def test_store_source_approved_release_writes_receipted_outputs() -> None:
    ...
    with TemporaryDirectory() as tmp:
        receipt = store_source_approved_release(outputs.as_dict(), tmp)
        assert receipt["schema_version"] == "source_approved_release_store_v1"
...
if __name__ == "__main__":
    test_store_source_approved_release_writes_receipted_outputs()
    print("Source Approved Release store self-test passed.")
