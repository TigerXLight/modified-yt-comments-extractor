...
SCHEMA_VERSION = "source_adapter_end_to_end_operator_execution_orchestrator_verifier_v1"


def verify_source_adapter_end_to_end_operator_execution_orchestrator_package(package: Mapping[str, Any]) -> dict[str, Any]:
...
def main() -> None:
    print(json.dumps(verify_source_adapter_end_to_end_operator_execution_orchestrator_package(example_end_to_end_operator_execution_orchestrator_package()), indent=2, sort_keys=True))
