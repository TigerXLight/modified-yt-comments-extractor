from source_adapter_roadmap_coverage_acceptance_audit_runtime import build_record
from source_adapter_roadmap_coverage_acceptance_audit_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter Roadmap Coverage Acceptance Audit Runtime store self-test passed.")
