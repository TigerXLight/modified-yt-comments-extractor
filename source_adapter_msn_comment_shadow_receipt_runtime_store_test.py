from source_adapter_msn_comment_shadow_receipt_runtime import build_record
from source_adapter_msn_comment_shadow_receipt_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter MSN Comment Shadow Receipt Runtime store self-test passed.")
