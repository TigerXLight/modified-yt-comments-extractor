from source_adapter_source_claim_review_closeout_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "source_claim_review_closeout"
...
if __name__ == "__main__":
    ...
    print("Source Adapter Source Claim Review Closeout Runtime self-test passed.")
