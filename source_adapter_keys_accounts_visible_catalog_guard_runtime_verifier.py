...
from source_adapter_keys_accounts_visible_catalog_guard_runtime import RUNTIME_STAGE, KeysAccountsVisibleCatalogGuardRecord


def verify_record(record: KeysAccountsVisibleCatalogGuardRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[KeysAccountsVisibleCatalogGuardRecord]) -> list[str]:
    issues: list[str] = []
