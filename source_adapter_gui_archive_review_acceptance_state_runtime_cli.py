...
from source_adapter_gui_archive_review_acceptance_state_runtime import build_default_record, build_record, render_record_text
from source_adapter_gui_archive_review_acceptance_state_runtime_store import RuntimeStore
from source_adapter_gui_archive_review_acceptance_state_runtime_verifier import verify_record, verify_records


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="GUI Archive Review Acceptance State runtime helper")
    parser.add_argument("--runtime-id", default="gui_archive_review_acceptance_state-cli")
...
def main(argv: list[str] | None = None) -> int:
    ...
    record = build_record(
        ...
        metadata={"runtime_title": "GUI Archive Review Acceptance State"},
    )
