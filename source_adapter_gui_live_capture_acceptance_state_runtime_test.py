from source_adapter_gui_live_capture_acceptance_state_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "gui_live_capture_acceptance_state"
...
if __name__ == "__main__":
    ...
    print("Source Adapter GUI Live Capture Acceptance State Runtime self-test passed.")
