from source_adapter_gui_keys_accounts_acceptance_state_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "gui_keys_accounts_acceptance_state"
...
if __name__ == "__main__":
    ...
    print("Source Adapter GUI KEYS Accounts Acceptance State Runtime self-test passed.")
