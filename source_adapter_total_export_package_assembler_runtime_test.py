...
from source_adapter_total_export_package_assembler_runtime import KEYS_ACCOUNTS_LABEL, STATUS, build_package


def test_total_export_package_assembler_runtime() -> None:
...
if __name__ == "__main__":
    test_total_export_package_assembler_runtime()
    print("Source Adapter Total Export Package Assembler Runtime self-test passed.")
