...
from source_adapter_provider_command_acceptance_gate_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Provider Command Acceptance Gate Runtime CLI self-test passed.")
