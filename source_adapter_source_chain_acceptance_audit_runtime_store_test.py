from source_adapter_source_chain_acceptance_audit_runtime import build_record
from source_adapter_source_chain_acceptance_audit_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter Source Chain Acceptance Audit Runtime store self-test passed.")
