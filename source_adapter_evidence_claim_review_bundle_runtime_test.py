from source_adapter_evidence_claim_review_bundle_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_evidence_claim_review_bundle_runtime_package
...
verification = verify_source_adapter_evidence_claim_review_bundle_runtime(package)
assert verification["verified"], verification
print("Source Adapter Evidence Claim Review Bundle Runtime self-test passed.")
