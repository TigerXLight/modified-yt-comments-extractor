...
package = example_source_adapter_browser_capture_execution_ticket_runtime_package()
...
verification = verify_source_adapter_browser_capture_execution_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter Browser Capture Execution Ticket Runtime self-test passed.")
