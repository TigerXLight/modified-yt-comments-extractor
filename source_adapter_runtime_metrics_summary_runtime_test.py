from source_adapter_runtime_metrics_summary_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_runtime_metrics_summary_runtime_package
...
verification = verify_source_adapter_runtime_metrics_summary_runtime(package)
assert verification["verified"], verification
print("Source Adapter Runtime Metrics Summary Runtime self-test passed.")
