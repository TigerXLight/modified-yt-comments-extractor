...
from source_adapter_keys_accounts_search_scope_guard_runtime import RUNTIME_STAGE, KeysAccountsSearchScopeGuardRecord


def verify_record(record: KeysAccountsSearchScopeGuardRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[KeysAccountsSearchScopeGuardRecord]) -> list[str]:
    issues: list[str] = []
