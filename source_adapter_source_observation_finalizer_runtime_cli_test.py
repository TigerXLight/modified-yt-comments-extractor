...
from source_adapter_source_observation_finalizer_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Source Observation Finalizer Runtime CLI self-test passed.")
