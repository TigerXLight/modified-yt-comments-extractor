...
from source_adapter_keys_accounts_secret_redaction_runtime import KEYS_ACCOUNTS_LABEL, STATUS, build_package


def test_keys_accounts_secret_redaction_runtime() -> None:
...
if __name__ == "__main__":
    test_keys_accounts_secret_redaction_runtime()
    print("Source Adapter KEYS Accounts Secret Redaction Runtime self-test passed.")
