from source_adapter_absolute_delivery_acceptance_bundle_closeout_runtime import build_record
from source_adapter_absolute_delivery_acceptance_bundle_closeout_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter Absolute Delivery Acceptance Bundle Closeout Runtime store self-test passed.")
