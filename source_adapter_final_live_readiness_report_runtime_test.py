...
verification = verify_source_adapter_final_live_readiness_report_runtime(package)
assert verification["verified"], verification
print("Source Adapter Final Live Readiness Report Runtime self-test passed.")
