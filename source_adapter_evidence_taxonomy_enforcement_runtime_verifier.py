...
from source_adapter_evidence_taxonomy_enforcement_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, ROW_STATUS, STATUS, example_source_adapter_evidence_taxonomy_enforcement_runtime_package

SCHEMA_VERSION = "source_adapter_evidence_taxonomy_enforcement_runtime_verifier_v1"


def verify_source_adapter_evidence_taxonomy_enforcement_runtime(package: Mapping[str, Any] | None = None) -> dict[str, Any]:
...
if __name__ == "__main__":
    print(json.dumps(verify_source_adapter_evidence_taxonomy_enforcement_runtime(), indent=2, sort_keys=True))
