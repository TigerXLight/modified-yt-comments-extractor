...
def run_self_test(args: argparse.Namespace) -> Dict[str, Any]:
    checks = [
        ...
        {'name': 'r45r_local_exhaust_present', 'status': 'pass' if 'r45r_local_exhaust_rule' in contract() and 'requestedLocalPasses' in r45h.JS_BOUNDED_MODAL_AUTO_EXPAND and 'Math.max(12' in r45h.JS_BOUNDED_MODAL_AUTO_EXPAND else 'fail'},
