from source_adapter_online_asr_receipt_import_bridge_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "online_asr_receipt_import_bridge"
...
if __name__ == "__main__":
    ...
    print("Source Adapter Online ASR Receipt Import Bridge Runtime self-test passed.")
