...
package = example_source_adapter_online_asr_visual_contract_ticket_runtime_package()
...
verification = verify_source_adapter_online_asr_visual_contract_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter Online ASR Visual Contract Ticket Runtime self-test passed.")
