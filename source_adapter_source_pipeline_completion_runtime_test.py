...
from source_adapter_source_pipeline_completion_runtime import KEYS_ACCOUNTS_LABEL, STATUS, build_package


def test_source_pipeline_completion_runtime() -> None:
...
if __name__ == "__main__":
    test_source_pipeline_completion_runtime()
    print("Source Adapter Source Pipeline Completion Runtime self-test passed.")
