...
from source_adapter_youtube_media_source_receipt_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter YouTube Media Source Receipt Runtime CLI self-test passed.")
