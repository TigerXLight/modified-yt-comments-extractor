...
verification = verify_source_adapter_keys_accounts_visible_provider_runtime(package)
assert verification["verified"], verification
print("Source Adapter KEYS Accounts Visible Provider Runtime self-test passed.")
