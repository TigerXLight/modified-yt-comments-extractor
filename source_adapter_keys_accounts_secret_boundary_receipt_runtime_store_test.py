from source_adapter_keys_accounts_secret_boundary_receipt_runtime import build_record
from source_adapter_keys_accounts_secret_boundary_receipt_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter KEYS Accounts Secret Boundary Receipt Runtime store self-test passed.")
