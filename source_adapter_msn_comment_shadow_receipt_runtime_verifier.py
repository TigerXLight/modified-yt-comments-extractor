...
from source_adapter_msn_comment_shadow_receipt_runtime import RUNTIME_STAGE, MsnCommentShadowReceiptRecord


def verify_record(record: MsnCommentShadowReceiptRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[MsnCommentShadowReceiptRecord]) -> list[str]:
    issues: list[str] = []
