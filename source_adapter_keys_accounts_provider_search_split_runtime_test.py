...
package = example_source_adapter_keys_accounts_provider_search_split_runtime_package()
...
verification = verify_source_adapter_keys_accounts_provider_search_split_runtime(package)
assert verification["verified"], verification
print("Source Adapter KEYS Accounts Provider Search Split Runtime self-test passed.")
