from source_adapter_provider_failure_resolution_gate_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "provider_failure_resolution_gate"
...
if __name__ == "__main__":
    ...
    print("Source Adapter Provider Failure Resolution Gate Runtime self-test passed.")
