...
from source_adapter_evidence_final_integrity_check_runtime import RUNTIME_STAGE, EvidenceFinalIntegrityCheckRecord


def verify_record(record: EvidenceFinalIntegrityCheckRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[EvidenceFinalIntegrityCheckRecord]) -> list[str]:
    issues: list[str] = []
