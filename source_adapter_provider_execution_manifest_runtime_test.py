...
from source_adapter_provider_execution_manifest_runtime import KEYS_ACCOUNTS_LABEL, STATUS, build_package


def test_provider_execution_manifest_runtime() -> None:
...
if __name__ == "__main__":
    test_provider_execution_manifest_runtime()
    print("Source Adapter Provider Execution Manifest Runtime self-test passed.")
