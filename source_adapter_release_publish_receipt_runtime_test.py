...
from source_adapter_release_publish_receipt_runtime import KEYS_ACCOUNTS_LABEL, STATUS, build_package


def test_release_publish_receipt_runtime() -> None:
...
if __name__ == "__main__":
    test_release_publish_receipt_runtime()
    print("Source Adapter Release Publish Receipt Runtime self-test passed.")
