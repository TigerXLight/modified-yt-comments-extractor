...
from source_adapter_article_comment_bundle_receipt_runtime import RUNTIME_STAGE, ArticleCommentBundleReceiptRecord


def verify_record(record: ArticleCommentBundleReceiptRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[ArticleCommentBundleReceiptRecord]) -> list[str]:
    issues: list[str] = []
