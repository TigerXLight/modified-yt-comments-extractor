from source_adapter_provider_command_acceptance_gate_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "provider_command_acceptance_gate"
...
if __name__ == "__main__":
    ...
    print("Source Adapter Provider Command Acceptance Gate Runtime self-test passed.")
