...
from source_adapter_operator_receipt_acceptance_gate_runtime import RUNTIME_STAGE, OperatorReceiptAcceptanceGateRecord


def verify_record(record: OperatorReceiptAcceptanceGateRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[OperatorReceiptAcceptanceGateRecord]) -> list[str]:
    issues: list[str] = []
