from source_adapter_operator_approval_acceptance_gate_runtime import build_record
from source_adapter_operator_approval_acceptance_gate_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter Operator Approval Acceptance Gate Runtime store self-test passed.")
