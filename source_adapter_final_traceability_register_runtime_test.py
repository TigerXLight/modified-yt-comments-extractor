...
verification = verify_source_adapter_final_traceability_register_runtime(package)
assert verification["verified"], verification
print("Source Adapter Final Traceability Register Runtime self-test passed.")
