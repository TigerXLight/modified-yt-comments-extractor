...
v = verify_source_adapter_gui_completion_state_runtime_package(example_source_adapter_gui_completion_state_runtime_package())
assert v["verified"], v
assert v["issue_count"] == 0, v
print("Source Adapter GUI Completion State Runtime verifier self-test passed.")
