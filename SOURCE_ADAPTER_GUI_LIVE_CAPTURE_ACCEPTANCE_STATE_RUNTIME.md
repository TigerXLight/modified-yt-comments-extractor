# Source Adapter GUI Live Capture Acceptance State Runtime

This slice records the **GUI Live Capture Acceptance State** stage for the shared Source Adapter / Total Export / Source Evidence roadmap.
...
- a stable runtime stage identifier: `gui_live_capture_acceptance_state`;
