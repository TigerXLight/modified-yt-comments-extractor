from source_adapter_shadow_comment_receipt_finalizer_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "shadow_comment_receipt_finalizer"
...
if __name__ == "__main__":
    ...
    print("Source Adapter Shadow Comment Receipt Finalizer Runtime self-test passed.")
