...
from source_adapter_named_site_profile_store_runtime import HANDOFF_STATUS, ROW_KEY, STATUS, example_source_adapter_named_site_profile_store_runtime_package

SCHEMA_VERSION = "source_adapter_named_site_profile_store_runtime_verifier_v1"


def verify_source_adapter_named_site_profile_store_runtime_package(package: Mapping[str, Any]) -> dict[str, Any]:
...
if __name__ == "__main__":
    print(json.dumps(verify_source_adapter_named_site_profile_store_runtime_package(example_source_adapter_named_site_profile_store_runtime_package()), indent=2, sort_keys=True))
