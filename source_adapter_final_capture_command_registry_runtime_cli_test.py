...
from source_adapter_final_capture_command_registry_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Final Capture Command Registry Runtime CLI self-test passed.")
