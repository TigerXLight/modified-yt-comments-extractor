...
from source_adapter_keys_accounts_secret_boundary_receipt_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter KEYS Accounts Secret Boundary Receipt Runtime CLI self-test passed.")
