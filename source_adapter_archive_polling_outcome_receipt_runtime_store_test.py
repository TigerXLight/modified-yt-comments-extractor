from source_adapter_archive_polling_outcome_receipt_runtime import build_record
from source_adapter_archive_polling_outcome_receipt_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter Archive Polling Outcome Receipt Runtime store self-test passed.")
