from source_adapter_x_post_archive_receipt_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "x_post_archive_receipt"
...
if __name__ == "__main__":
    ...
    print("Source Adapter X Post Archive Receipt Runtime self-test passed.")
