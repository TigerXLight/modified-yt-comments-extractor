from source_adapter_provider_failure_escalation_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_provider_failure_escalation_runtime_package
...
verification = verify_source_adapter_provider_failure_escalation_runtime(package)
assert verification["verified"], verification
print("Source Adapter Provider Failure Escalation Runtime self-test passed.")
