from source_adapter_provider_receipt_acceptance_gate_runtime import build_record
from source_adapter_provider_receipt_acceptance_gate_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter Provider Receipt Acceptance Gate Runtime store self-test passed.")
