...
from source_adapter_evidence_final_integrity_check_runtime import build_default_record, build_record, render_record_text
from source_adapter_evidence_final_integrity_check_runtime_store import RuntimeStore
from source_adapter_evidence_final_integrity_check_runtime_verifier import verify_record, verify_records


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Evidence Final Integrity Check runtime helper")
    parser.add_argument("--runtime-id", default="evidence_final_integrity_check-cli")
...
def main(argv: list[str] | None = None) -> int:
    ...
    record = build_record(
        ...
        metadata={"runtime_title": "Evidence Final Integrity Check"},
    )
