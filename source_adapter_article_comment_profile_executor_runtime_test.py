...
package = example_source_adapter_article_comment_profile_executor_runtime_package()
...
verification = verify_source_adapter_article_comment_profile_executor_runtime(package)
assert verification["verified"], verification
print("Source Adapter Article Comment Profile Executor Runtime self-test passed.")
