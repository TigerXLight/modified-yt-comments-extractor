from source_adapter_evidence_queue_release_dispatch_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "evidence_queue_release_dispatch"
...
if __name__ == "__main__":
    ...
    print("Source Adapter Evidence Queue Release Dispatch Runtime self-test passed.")
