...
with tempfile.TemporaryDirectory() as tmp:
    result = store_source_adapter_x_profile_runtime_package(example_source_adapter_x_profile_runtime_package(), tmp)
...
print("Source Adapter X Twitter Profile Runtime store self-test passed.")
