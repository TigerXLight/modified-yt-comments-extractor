from source_adapter_live_run_state_machine_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_live_run_state_machine_runtime_package
...
verification = verify_source_adapter_live_run_state_machine_runtime(package)
assert verification["verified"], verification
print("Source Adapter Live Run State Machine Runtime self-test passed.")
