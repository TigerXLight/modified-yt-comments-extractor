from source_adapter_action_log_hashchain_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_action_log_hashchain_runtime_package
...
verification = verify_source_adapter_action_log_hashchain_runtime(package)
assert verification["verified"], verification
print("Source Adapter Action Log Hashchain Runtime self-test passed.")
