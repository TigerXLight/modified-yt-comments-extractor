from source_adapter_operator_live_approval_form_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_operator_live_approval_form_runtime_package
...
verification = verify_source_adapter_operator_live_approval_form_runtime(package)
assert verification["verified"], verification
print("Source Adapter Operator Live Approval Form Runtime self-test passed.")
