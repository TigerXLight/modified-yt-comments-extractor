...
v = verify_source_adapter_total_export_finalization_runtime_package(example_source_adapter_total_export_finalization_runtime_package())
assert v["verified"], v
assert v["issue_count"] == 0, v
print("Source Adapter Total Export Finalization Runtime verifier self-test passed.")
