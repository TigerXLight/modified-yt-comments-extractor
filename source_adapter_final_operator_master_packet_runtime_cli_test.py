...
from source_adapter_final_operator_master_packet_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Final Operator Master Packet Runtime CLI self-test passed.")
