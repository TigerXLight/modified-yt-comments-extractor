...
from source_adapter_provider_receipt_acceptance_gate_runtime import RUNTIME_STAGE, ProviderReceiptAcceptanceGateRecord


def verify_record(record: ProviderReceiptAcceptanceGateRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[ProviderReceiptAcceptanceGateRecord]) -> list[str]:
    issues: list[str] = []
