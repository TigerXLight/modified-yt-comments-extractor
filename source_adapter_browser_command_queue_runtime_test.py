from source_adapter_browser_command_queue_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_browser_command_queue_runtime_package
...
verification = verify_source_adapter_browser_command_queue_runtime(package)
assert verification["verified"], verification
print("Source Adapter Browser Command Queue Runtime self-test passed.")
