...
from source_adapter_gui_archive_review_acceptance_state_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter GUI Archive Review Acceptance State Runtime CLI self-test passed.")
