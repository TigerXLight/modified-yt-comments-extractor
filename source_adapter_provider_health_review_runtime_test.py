from source_adapter_provider_health_review_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_provider_health_review_runtime_package
...
verification = verify_source_adapter_provider_health_review_runtime(package)
assert verification["verified"], verification
print("Source Adapter Provider Health Review Runtime self-test passed.")
