...
package = example_source_adapter_release_artifact_delivery_gate_runtime_package()
...
verification = verify_source_adapter_release_artifact_delivery_gate_runtime(package)
assert verification["verified"], verification
print("Source Adapter Release Artifact Delivery Gate Runtime self-test passed.")
