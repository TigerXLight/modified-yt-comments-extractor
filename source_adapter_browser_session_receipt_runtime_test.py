from source_adapter_browser_session_receipt_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_browser_session_receipt_runtime_package
...
verification = verify_source_adapter_browser_session_receipt_runtime(package)
assert verification["verified"], verification
print("Source Adapter Browser Session Receipt Runtime self-test passed.")
