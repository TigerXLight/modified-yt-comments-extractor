...
verification = verify_source_adapter_gui_live_capture_wizard_state_runtime(package)
assert verification["verified"], verification
print("Source Adapter GUI Live Capture Wizard State Runtime self-test passed.")
