...
from source_adapter_provider_capability_registry_runtime import KEYS_ACCOUNTS_LABEL, STATUS, build_package


def test_provider_capability_registry_runtime() -> None:
...
if __name__ == "__main__":
    test_provider_capability_registry_runtime()
    print("Source Adapter Provider Capability Registry Runtime self-test passed.")
