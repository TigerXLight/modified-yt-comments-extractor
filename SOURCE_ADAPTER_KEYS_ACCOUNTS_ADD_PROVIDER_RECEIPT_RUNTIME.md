# Source Adapter KEYS Accounts Add Provider Receipt Runtime

This slice records the **KEYS Accounts Add Provider Receipt** stage for the shared Source Adapter / Total Export / Source Evidence roadmap.
...
- a stable runtime stage identifier: `keys_accounts_add_provider_receipt`;
