...
CAPTURE_OPTION_METADATA = (
    ...
    CaptureOptionMetadata(
        ...
        description="Current manual/metadata fields for tracking where media was observed, credited, reposted, or disputed.",
        stage=CAPTURE_STAGE_PLANNED,
        default_enabled_for_total_export=True,
        implementation_notes="Schema/export support is current; automated acquisition, matching, and fingerprinting remain separate future work.",
    ),
    CaptureOptionMetadata(
        option_id=CAPTURE_DISPUTED_FRAMING_NOTES,
        display_name="Disputed framing notes",
        description="Current manual metadata notes for publisher framing disputes or source-author corrections.",
        stage=CAPTURE_STAGE_PLANNED,
        default_enabled_for_total_export=True,
        implementation_notes="Manual/imported fields are current; automated dispute detection is not implied.",
    ),
    CaptureOptionMetadata(
        option_id=CAPTURE_SOURCE_ROLE_LABELS,
        display_name="Source-role labels",
        description="Current claim/source role labels for evidence review and export additional information.",
        stage=CAPTURE_STAGE_PLANNED,
        default_enabled_for_total_export=True,
        implementation_notes="Fields are preserved now; automatic source-role classification remains operator-reviewed/manual.",
    ),
)
