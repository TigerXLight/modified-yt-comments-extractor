from source_adapter_project_handoff_acceptance_audit_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "project_handoff_acceptance_audit"
...
if __name__ == "__main__":
    ...
    print("Source Adapter Project Handoff Acceptance Audit Runtime self-test passed.")
