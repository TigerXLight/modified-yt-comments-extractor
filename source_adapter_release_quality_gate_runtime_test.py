from source_adapter_release_quality_gate_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_release_quality_gate_runtime_package
...
verification = verify_source_adapter_release_quality_gate_runtime(package)
assert verification["verified"], verification
print("Source Adapter Release Quality Gate Runtime self-test passed.")
