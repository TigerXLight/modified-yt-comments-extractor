...
package = example_source_adapter_final_gui_readiness_report_runtime_package()
...
verification = verify_source_adapter_final_gui_readiness_report_runtime(package)
assert verification["verified"], verification
print("Source Adapter Final GUI Readiness Report Runtime self-test passed.")
