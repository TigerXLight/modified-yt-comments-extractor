...
from source_adapter_total_export_release_bundle_index_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Total Export Release Bundle Index Runtime CLI self-test passed.")
