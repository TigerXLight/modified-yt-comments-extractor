# Source Adapter GUI KEYS Accounts Acceptance State Runtime

This slice records the **GUI KEYS Accounts Acceptance State** stage for the shared Source Adapter / Total Export / Source Evidence roadmap.
...
- a stable runtime stage identifier: `gui_keys_accounts_acceptance_state`;
