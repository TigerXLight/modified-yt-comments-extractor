...
verification = verify_source_adapter_capture_media_receipt_mapper_runtime(package)
assert verification["verified"], verification
print("Source Adapter Capture Media Receipt Mapper Runtime self-test passed.")
