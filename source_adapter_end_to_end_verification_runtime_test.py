from source_adapter_end_to_end_verification_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_end_to_end_verification_runtime_package
...
verification = verify_source_adapter_end_to_end_verification_runtime(package)
assert verification["verified"], verification
print("Source Adapter End-to-End Verification Runtime self-test passed.")
