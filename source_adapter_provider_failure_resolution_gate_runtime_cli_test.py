...
from source_adapter_provider_failure_resolution_gate_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Provider Failure Resolution Gate Runtime CLI self-test passed.")
