...
verification = verify_source_adapter_evidence_item_commit_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter Evidence Item Commit Ticket Runtime self-test passed.")
