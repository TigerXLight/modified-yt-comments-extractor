...
from source_adapter_evidence_item_release_commit_runtime import RUNTIME_STAGE, EvidenceItemReleaseCommitRecord


def verify_record(record: EvidenceItemReleaseCommitRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[EvidenceItemReleaseCommitRecord]) -> list[str]:
    issues: list[str] = []
