from source_adapter_release_index_publish_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_release_index_publish_runtime_package
...
verification = verify_source_adapter_release_index_publish_runtime(package)
assert verification["verified"], verification
print("Source Adapter Release Index Publish Runtime self-test passed.")
