...
verification = verify_source_adapter_source_to_evidence_commit_bridge_runtime(package)
assert verification["verified"], verification
print("Source Adapter Source To Evidence Commit Bridge Runtime self-test passed.")
