...
from source_adapter_final_operator_master_packet_runtime import RUNTIME_STAGE, FinalOperatorMasterPacketRecord


def verify_record(record: FinalOperatorMasterPacketRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[FinalOperatorMasterPacketRecord]) -> list[str]:
    issues: list[str] = []
