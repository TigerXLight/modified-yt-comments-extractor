from source_adapter_final_operator_master_packet_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "final_operator_master_packet"
...
if __name__ == "__main__":
    ...
    print("Source Adapter Final Operator Master Packet Runtime self-test passed.")
