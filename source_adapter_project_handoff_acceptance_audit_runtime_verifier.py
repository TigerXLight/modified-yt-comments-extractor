...
from source_adapter_project_handoff_acceptance_audit_runtime import RUNTIME_STAGE, ProjectHandoffAcceptanceAuditRecord


def verify_record(record: ProjectHandoffAcceptanceAuditRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[ProjectHandoffAcceptanceAuditRecord]) -> list[str]:
    issues: list[str] = []
