...
verification = verify_source_adapter_final_provider_readiness_report_runtime(package)
assert verification["verified"], verification
print("Source Adapter Final Provider Readiness Report Runtime self-test passed.")
