...
package = example_source_adapter_capture_browser_receipt_mapper_runtime_package()
...
verification = verify_source_adapter_capture_browser_receipt_mapper_runtime(package)
assert verification["verified"], verification
print("Source Adapter Capture Browser Receipt Mapper Runtime self-test passed.")
