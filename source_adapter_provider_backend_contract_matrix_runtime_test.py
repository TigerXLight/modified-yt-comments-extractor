...
verification = verify_source_adapter_provider_backend_contract_matrix_runtime(package)
assert verification["verified"], verification
print("Source Adapter Provider Backend Contract Matrix Runtime self-test passed.")
