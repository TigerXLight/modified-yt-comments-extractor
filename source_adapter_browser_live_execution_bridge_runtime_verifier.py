...
from source_adapter_browser_live_execution_bridge_runtime import RUNTIME_STAGE, BrowserLiveExecutionBridgeRecord


def verify_record(record: BrowserLiveExecutionBridgeRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[BrowserLiveExecutionBridgeRecord]) -> list[str]:
    issues: list[str] = []
