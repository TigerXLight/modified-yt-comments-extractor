...
from source_adapter_gui_archive_review_acceptance_state_runtime import RUNTIME_STAGE, GuiArchiveReviewAcceptanceStateRecord


def verify_record(record: GuiArchiveReviewAcceptanceStateRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[GuiArchiveReviewAcceptanceStateRecord]) -> list[str]:
    issues: list[str] = []
