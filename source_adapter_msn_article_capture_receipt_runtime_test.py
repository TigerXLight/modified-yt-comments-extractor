from source_adapter_msn_article_capture_receipt_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "msn_article_capture_receipt"
...
if __name__ == "__main__":
    ...
    print("Source Adapter MSN Article Capture Receipt Runtime self-test passed.")
