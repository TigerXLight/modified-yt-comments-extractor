...
package = example_source_adapter_source_chain_final_audit_runtime_package()
...
verification = verify_source_adapter_source_chain_final_audit_runtime(package)
assert verification["verified"], verification
print("Source Adapter Source Chain Final Audit Runtime self-test passed.")
