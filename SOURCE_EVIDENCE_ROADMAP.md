...
- The next REV4 implementation gap is Total Export/evidence queue connection after the UI/controller preview; live/manual site smoke or any real-site adapter step remains separately approval-gated and should use local fixtures/mocks first.
