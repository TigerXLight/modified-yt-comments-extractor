...
- The next REV4 implementation gap is WARC/WACZ fixture/mock coverage; live/manual site smoke or any real-site adapter step remains separately approval-gated and should use local fixtures/mocks first.
