...
- Details use plain language, hide raw implementation/provenance/diagnostic enum fields, show explicit official provider/API-key/pricing link buttons when known, and use "Key input" for masked secure credential entry.
