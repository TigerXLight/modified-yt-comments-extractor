...
v = verify_source_adapter_operator_dashboard_runtime_package(example_source_adapter_operator_dashboard_runtime_package())
assert v["verified"], v
assert v["issue_count"] == 0, v
print("Source Adapter Operator Dashboard Runtime verifier self-test passed.")
