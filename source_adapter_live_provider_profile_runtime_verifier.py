...
SCHEMA_VERSION = "source_adapter_live_provider_profile_runtime_verifier_v1"


def verify_source_adapter_live_provider_profile_runtime_package(package: Mapping[str, Any]) -> dict[str, Any]:
...
def main() -> None:
    print(json.dumps(verify_source_adapter_live_provider_profile_runtime_package(example_live_provider_profile_runtime_package()), indent=2, sort_keys=True))
