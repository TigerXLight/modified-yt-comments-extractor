from source_adapter_source_receipt_chain_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_source_receipt_chain_runtime_package
...
verification = verify_source_adapter_source_receipt_chain_runtime(package)
assert verification["verified"], verification
print("Source Adapter Source Receipt Chain Runtime self-test passed.")
