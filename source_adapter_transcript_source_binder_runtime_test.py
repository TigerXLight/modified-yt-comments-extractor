from source_adapter_transcript_source_binder_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_transcript_source_binder_runtime_package
...
verification = verify_source_adapter_transcript_source_binder_runtime(package)
assert verification["verified"], verification
print("Source Adapter Transcript Source Binder Runtime self-test passed.")
