...
package = example_source_adapter_traceability_crosscheck_ticket_runtime_package()
...
verification = verify_source_adapter_traceability_crosscheck_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter Traceability Crosscheck Ticket Runtime self-test passed.")
