...
from source_adapter_evidence_item_release_commit_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Evidence Item Release Commit Runtime CLI self-test passed.")
