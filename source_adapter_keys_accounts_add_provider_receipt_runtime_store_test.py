from source_adapter_keys_accounts_add_provider_receipt_runtime import build_record
from source_adapter_keys_accounts_add_provider_receipt_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter KEYS Accounts Add Provider Receipt Runtime store self-test passed.")
