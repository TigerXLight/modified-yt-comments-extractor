...
verification = verify_source_adapter_total_export_release_indexer_runtime(package)
assert verification["verified"], verification
print("Source Adapter Total Export Release Indexer Runtime self-test passed.")
