...
package = example_source_adapter_release_upload_receipt_ticket_runtime_package()
...
verification = verify_source_adapter_release_upload_receipt_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter Release Upload Receipt Ticket Runtime self-test passed.")
