from source_adapter_traceability_final_crosscheck_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "traceability_final_crosscheck"
...
if __name__ == "__main__":
    ...
    print("Source Adapter Traceability Final Crosscheck Runtime self-test passed.")
