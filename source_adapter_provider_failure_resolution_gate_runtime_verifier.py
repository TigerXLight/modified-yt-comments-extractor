...
from source_adapter_provider_failure_resolution_gate_runtime import RUNTIME_STAGE, ProviderFailureResolutionGateRecord


def verify_record(record: ProviderFailureResolutionGateRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[ProviderFailureResolutionGateRecord]) -> list[str]:
    issues: list[str] = []
