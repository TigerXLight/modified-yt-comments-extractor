from source_adapter_local_asr_large_v3_vulkan_profile_runtime import build_record
from source_adapter_local_asr_large_v3_vulkan_profile_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter Local ASR Large V3 Vulkan Profile Runtime store self-test passed.")
