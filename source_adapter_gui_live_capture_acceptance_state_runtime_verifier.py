...
from source_adapter_gui_live_capture_acceptance_state_runtime import RUNTIME_STAGE, GuiLiveCaptureAcceptanceStateRecord


def verify_record(record: GuiLiveCaptureAcceptanceStateRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[GuiLiveCaptureAcceptanceStateRecord]) -> list[str]:
    issues: list[str] = []
