from source_adapter_live_smoke_plan_runner_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_live_smoke_plan_runner_runtime_package
...
verification = verify_source_adapter_live_smoke_plan_runner_runtime(package)
assert verification["verified"], verification
print("Source Adapter Live Smoke Plan Runner Runtime self-test passed.")
