...
with tempfile.TemporaryDirectory() as tmp:
    result = store_source_adapter_full_execution_integration_bundle_closeout_package(example_full_execution_integration_bundle_closeout_package(), tmp)
...
print("Source Adapter Full Execution Integration Bundle Closeout store self-test passed.")
