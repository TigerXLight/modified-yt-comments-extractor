...
from source_adapter_local_asr_large_v3_vulkan_profile_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Local ASR Large V3 Vulkan Profile Runtime CLI self-test passed.")
