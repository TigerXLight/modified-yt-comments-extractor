...
package = example_source_adapter_msn_operator_capture_ticket_runtime_package()
...
verification = verify_source_adapter_msn_operator_capture_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter MSN Operator Capture Ticket Runtime self-test passed.")
