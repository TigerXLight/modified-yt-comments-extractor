...
from source_adapter_keys_accounts_add_provider_receipt_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter KEYS Accounts Add Provider Receipt Runtime CLI self-test passed.")
