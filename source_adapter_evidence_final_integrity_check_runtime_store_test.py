from source_adapter_evidence_final_integrity_check_runtime import build_record
from source_adapter_evidence_final_integrity_check_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter Evidence Final Integrity Check Runtime store self-test passed.")
