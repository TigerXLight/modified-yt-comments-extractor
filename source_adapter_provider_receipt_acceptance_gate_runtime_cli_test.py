...
from source_adapter_provider_receipt_acceptance_gate_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Provider Receipt Acceptance Gate Runtime CLI self-test passed.")
