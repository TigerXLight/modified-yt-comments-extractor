...
verification = verify_source_adapter_x_public_post_archive_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter X Public Post Archive Ticket Runtime self-test passed.")
