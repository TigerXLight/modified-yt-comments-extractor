...
from source_adapter_gui_online_asr_acceptance_state_runtime import RUNTIME_STAGE, GuiOnlineAsrAcceptanceStateRecord


def verify_record(record: GuiOnlineAsrAcceptanceStateRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[GuiOnlineAsrAcceptanceStateRecord]) -> list[str]:
    issues: list[str] = []
