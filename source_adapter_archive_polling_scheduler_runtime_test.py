from source_adapter_archive_polling_scheduler_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_archive_polling_scheduler_runtime_package
...
verification = verify_source_adapter_archive_polling_scheduler_runtime(package)
assert verification["verified"], verification
print("Source Adapter Archive Polling Scheduler Runtime self-test passed.")
