...
from source_adapter_online_asr_receipt_import_bridge_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Online ASR Receipt Import Bridge Runtime CLI self-test passed.")
