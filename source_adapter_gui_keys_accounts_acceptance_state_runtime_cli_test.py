...
from source_adapter_gui_keys_accounts_acceptance_state_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter GUI KEYS Accounts Acceptance State Runtime CLI self-test passed.")
