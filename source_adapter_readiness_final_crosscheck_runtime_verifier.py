...
from source_adapter_readiness_final_crosscheck_runtime import RUNTIME_STAGE, ReadinessFinalCrosscheckRecord


def verify_record(record: ReadinessFinalCrosscheckRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[ReadinessFinalCrosscheckRecord]) -> list[str]:
    issues: list[str] = []
