...
package = example_source_adapter_msn_live_profile_executor_runtime_package()
...
verification = verify_source_adapter_msn_live_profile_executor_runtime(package)
assert verification["verified"], verification
print("Source Adapter MSN Live Profile Executor Runtime self-test passed.")
