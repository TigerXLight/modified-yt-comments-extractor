from source_adapter_transcript_asr_receipt_finalizer_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "transcript_asr_receipt_finalizer"
...
if __name__ == "__main__":
    ...
    print("Source Adapter Transcript ASR Receipt Finalizer Runtime self-test passed.")
