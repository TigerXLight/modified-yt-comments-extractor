...
from source_adapter_release_file_library_finalizer_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Release File Library Finalizer Runtime CLI self-test passed.")
