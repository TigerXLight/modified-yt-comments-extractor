from source_adapter_browser_live_execution_bridge_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "browser_live_execution_bridge"
...
if __name__ == "__main__":
    ...
    print("Source Adapter Browser Live Execution Bridge Runtime self-test passed.")
