...
def _live_evidence_summary_from_r43n(smoke_payload: Mapping[str, Any], receipt: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "profile_preflight_status": _clean(receipt.get("profile_preflight_status")),
        "profile_preflight_summary": dict(receipt.get("profile_preflight_summary") or {}),
        "profile_preflight_summary_path": _clean(receipt.get("profile_preflight_summary_path")),
