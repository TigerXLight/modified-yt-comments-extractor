...
robocopy "%SOURCE%" "%DEST%" main.py extractor.py spam_filter.py transcript_tools.py youtube_transcript_downloader.py requirements.txt youtube_video_metadata.py README.md RELEASE_NOTES.md LICENSE run_app.bat updater.py evidence_exporter.py asr_defaults.py asr_tools.py /R:1 /W:1
