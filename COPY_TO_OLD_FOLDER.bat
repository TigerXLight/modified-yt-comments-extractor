...
robocopy "%SOURCE%" "%DEST%" main.py extractor.py spam_filter.py transcript_tools.py youtube_transcript_downloader.py requirements.txt youtube_video_metadata.py README.md RELEASE_NOTES.md LICENSE run_app.bat updater.py evidence_exporter.py asr_defaults.py asr_tools.py RUN_WHISPERCPP_MATRIX.py CURRENT_DEV_STATE.md ASR_TEST_PLAN.md asr_topic_resolver.py asr_settings_dialog.py asr_calibration.py asr_quality_policy.py asr_whispercpp.py /R:1 /W:1
