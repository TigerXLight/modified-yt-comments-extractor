...
from source_adapter_release_upload_target_runtime import KEYS_ACCOUNTS_LABEL, STATUS, build_package


def test_release_upload_target_runtime() -> None:
...
if __name__ == "__main__":
    test_release_upload_target_runtime()
    print("Source Adapter Release Upload Target Runtime self-test passed.")
