from source_adapter_runtime_gap_report_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_runtime_gap_report_runtime_package
...
verification = verify_source_adapter_runtime_gap_report_runtime(package)
assert verification["verified"], verification
print("Source Adapter Runtime Gap Report Runtime self-test passed.")
