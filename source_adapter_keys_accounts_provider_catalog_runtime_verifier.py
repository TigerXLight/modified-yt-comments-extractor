...
SCHEMA_VERSION = "source_adapter_keys_accounts_provider_catalog_runtime_verifier_v1"


def verify_source_adapter_keys_accounts_provider_catalog_runtime_package(package: Mapping[str, Any]) -> dict[str, Any]:
...
if __name__ == "__main__":
    print(json.dumps(verify_source_adapter_keys_accounts_provider_catalog_runtime_package(example_source_adapter_keys_accounts_provider_catalog_runtime_package()), indent=2, sort_keys=True))
