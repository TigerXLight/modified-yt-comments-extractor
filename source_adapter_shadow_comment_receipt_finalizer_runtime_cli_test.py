...
from source_adapter_shadow_comment_receipt_finalizer_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Shadow Comment Receipt Finalizer Runtime CLI self-test passed.")
