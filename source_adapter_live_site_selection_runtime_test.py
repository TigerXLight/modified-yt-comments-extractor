from source_adapter_live_site_selection_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_live_site_selection_runtime_package
...
verification = verify_source_adapter_live_site_selection_runtime(package)
assert verification["verified"], verification
print("Source Adapter Live Site Selection Runtime self-test passed.")
