from source_adapter_gui_execution_command_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_gui_execution_command_runtime_package
...
verification = verify_source_adapter_gui_execution_command_runtime(package)
assert verification["verified"], verification
print("Source Adapter GUI Execution Command Runtime self-test passed.")
