from source_adapter_youtube_media_source_receipt_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "youtube_media_source_receipt"
...
if __name__ == "__main__":
    ...
    print("Source Adapter YouTube Media Source Receipt Runtime self-test passed.")
