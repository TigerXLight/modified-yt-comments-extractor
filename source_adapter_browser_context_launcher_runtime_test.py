from source_adapter_browser_context_launcher_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_browser_context_launcher_runtime_package
...
verification = verify_source_adapter_browser_context_launcher_runtime(package)
assert verification["verified"], verification
print("Source Adapter Browser Context Launcher Runtime self-test passed.")
