...
from source_adapter_evidence_item_materialization_runtime import KEYS_ACCOUNTS_LABEL, STATUS, build_package


def test_evidence_item_materialization_runtime() -> None:
...
if __name__ == "__main__":
    test_evidence_item_materialization_runtime()
    print("Source Adapter Evidence Item Materialization Runtime self-test passed.")
