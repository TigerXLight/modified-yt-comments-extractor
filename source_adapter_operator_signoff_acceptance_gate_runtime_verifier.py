...
from source_adapter_operator_signoff_acceptance_gate_runtime import RUNTIME_STAGE, OperatorSignoffAcceptanceGateRecord


def verify_record(record: OperatorSignoffAcceptanceGateRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[OperatorSignoffAcceptanceGateRecord]) -> list[str]:
    issues: list[str] = []
