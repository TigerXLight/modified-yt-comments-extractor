...
package = example_source_adapter_asr_result_source_binding_runtime_package()
...
verification = verify_source_adapter_asr_result_source_binding_runtime(package)
assert verification["verified"], verification
print("Source Adapter ASR Result Source Binding Runtime self-test passed.")
