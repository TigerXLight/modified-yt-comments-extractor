...
package = example_source_adapter_gui_live_run_ticket_runtime_package()
...
verification = verify_source_adapter_gui_live_run_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter GUI Live Run Ticket Runtime self-test passed.")
