from source_adapter_gui_archive_review_panel_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_gui_archive_review_panel_runtime_package
...
verification = verify_source_adapter_gui_archive_review_panel_runtime(package)
assert verification["verified"], verification
print("Source Adapter GUI Archive Review Panel Runtime self-test passed.")
