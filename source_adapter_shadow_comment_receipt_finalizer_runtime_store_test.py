from source_adapter_shadow_comment_receipt_finalizer_runtime import build_record
from source_adapter_shadow_comment_receipt_finalizer_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter Shadow Comment Receipt Finalizer Runtime store self-test passed.")
