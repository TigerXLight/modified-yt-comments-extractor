...
from source_adapter_online_asr_visual_parity_guard_runtime import build_default_record, build_record, render_record_text
from source_adapter_online_asr_visual_parity_guard_runtime_store import RuntimeStore
from source_adapter_online_asr_visual_parity_guard_runtime_verifier import verify_record, verify_records


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Online ASR Visual Parity Guard runtime helper")
    parser.add_argument("--runtime-id", default="online_asr_visual_parity_guard-cli")
...
def main(argv: list[str] | None = None) -> int:
    ...
    record = build_record(
        ...
        metadata={"runtime_title": "Online ASR Visual Parity Guard"},
    )
