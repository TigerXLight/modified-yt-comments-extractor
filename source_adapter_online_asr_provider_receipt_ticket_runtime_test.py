...
package = example_source_adapter_online_asr_provider_receipt_ticket_runtime_package()
...
verification = verify_source_adapter_online_asr_provider_receipt_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter Online ASR Provider Receipt Ticket Runtime self-test passed.")
