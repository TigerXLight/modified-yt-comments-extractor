...
from source_adapter_msn_article_capture_receipt_runtime import RUNTIME_STAGE, MsnArticleCaptureReceiptRecord


def verify_record(record: MsnArticleCaptureReceiptRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[MsnArticleCaptureReceiptRecord]) -> list[str]:
    issues: list[str] = []
