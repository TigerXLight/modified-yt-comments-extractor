...
from source_adapter_total_export_source_bundle_index_runtime import RUNTIME_STAGE, TotalExportSourceBundleIndexRecord


def verify_record(record: TotalExportSourceBundleIndexRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[TotalExportSourceBundleIndexRecord]) -> list[str]:
    issues: list[str] = []
