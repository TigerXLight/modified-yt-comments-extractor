...
from source_adapter_youtube_comment_source_receipt_runtime import RUNTIME_STAGE, YoutubeCommentSourceReceiptRecord


def verify_record(record: YoutubeCommentSourceReceiptRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[YoutubeCommentSourceReceiptRecord]) -> list[str]:
    issues: list[str] = []
