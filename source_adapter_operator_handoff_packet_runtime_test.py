from source_adapter_operator_handoff_packet_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_operator_handoff_packet_runtime_package
...
verification = verify_source_adapter_operator_handoff_packet_runtime(package)
assert verification["verified"], verification
print("Source Adapter Operator Handoff Packet Runtime self-test passed.")
