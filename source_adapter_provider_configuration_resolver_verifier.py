...
SCHEMA_VERSION = "source_adapter_provider_configuration_resolver_verifier_v1"


def verify_source_adapter_provider_configuration_resolver_package(package: Mapping[str, Any]) -> dict[str, Any]:
...
if __name__ == "__main__":
    print(json.dumps(verify_source_adapter_provider_configuration_resolver_package(example_source_adapter_provider_configuration_resolver_package()), indent=2, sort_keys=True))
