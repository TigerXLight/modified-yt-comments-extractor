...
from source_adapter_total_export_source_indexer_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, LOCAL_ASR_PROFILE, ONLINE_ASR_CANDIDATE, ROW_KEY, STATUS, example_source_adapter_total_export_source_indexer_runtime_package


def verify_source_adapter_total_export_source_indexer_runtime(package: Mapping[str, Any] | None = None) -> dict[str, Any]:
    ...
    return {
        "schema_version": "source_adapter_total_export_source_indexer_runtime_verification_v1",
        "verified": not issues,
...
if __name__ == "__main__":
    print(json.dumps(verify_source_adapter_total_export_source_indexer_runtime(), indent=2, sort_keys=True))
