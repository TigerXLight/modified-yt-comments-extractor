...
from source_adapter_roadmap_coverage_acceptance_audit_runtime import RUNTIME_STAGE, RoadmapCoverageAcceptanceAuditRecord


def verify_record(record: RoadmapCoverageAcceptanceAuditRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[RoadmapCoverageAcceptanceAuditRecord]) -> list[str]:
    issues: list[str] = []
