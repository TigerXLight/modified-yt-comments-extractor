from source_adapter_browser_live_execution_bridge_runtime import build_record
from source_adapter_browser_live_execution_bridge_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter Browser Live Execution Bridge Runtime store self-test passed.")
