from source_adapter_shadow_dom_selector_registry_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_shadow_dom_selector_registry_runtime_package
...
verification = verify_source_adapter_shadow_dom_selector_registry_runtime(package)
assert verification["verified"], verification
print("Source Adapter Shadow DOM Selector Registry Runtime self-test passed.")
