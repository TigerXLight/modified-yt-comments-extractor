from source_adapter_youtube_comment_source_receipt_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "youtube_comment_source_receipt"
...
if __name__ == "__main__":
    ...
    print("Source Adapter YouTube Comment Source Receipt Runtime self-test passed.")
