...
verification = verify_source_adapter_total_export_release_chapter_runtime(package)
assert verification["verified"], verification
print("Source Adapter Total Export Release Chapter Runtime self-test passed.")
