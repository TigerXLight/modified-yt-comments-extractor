from source_adapter_provider_capability_docs_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_provider_capability_docs_runtime_package
...
verification = verify_source_adapter_provider_capability_docs_runtime(package)
assert verification["verified"], verification
print("Source Adapter Provider Capability Docs Runtime self-test passed.")
