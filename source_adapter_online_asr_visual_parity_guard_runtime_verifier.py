...
from source_adapter_online_asr_visual_parity_guard_runtime import RUNTIME_STAGE, OnlineAsrVisualParityGuardRecord


def verify_record(record: OnlineAsrVisualParityGuardRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[OnlineAsrVisualParityGuardRecord]) -> list[str]:
    issues: list[str] = []
