from source_adapter_final_operator_master_packet_runtime import build_record
from source_adapter_final_operator_master_packet_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter Final Operator Master Packet Runtime store self-test passed.")
