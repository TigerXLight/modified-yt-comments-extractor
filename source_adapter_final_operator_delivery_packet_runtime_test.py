...
verification = verify_source_adapter_final_operator_delivery_packet_runtime(package)
assert verification["verified"], verification
print("Source Adapter Final Operator Delivery Packet Runtime self-test passed.")
