...
from source_adapter_keys_accounts_search_scope_guard_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter KEYS Accounts Search Scope Guard Runtime CLI self-test passed.")
