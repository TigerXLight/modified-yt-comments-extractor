...
package = example_source_adapter_youtube_transcript_profile_executor_runtime_package()
...
verification = verify_source_adapter_youtube_transcript_profile_executor_runtime(package)
assert verification["verified"], verification
print("Source Adapter YouTube Transcript Profile Executor Runtime self-test passed.")
