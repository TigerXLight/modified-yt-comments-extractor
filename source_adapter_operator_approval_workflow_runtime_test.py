from source_adapter_operator_approval_workflow_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_operator_approval_workflow_runtime_package
...
verification = verify_source_adapter_operator_approval_workflow_runtime(package)
assert verification["verified"], verification
print("Source Adapter Operator Approval Workflow Runtime self-test passed.")
