...
SCHEMA_VERSION = "source_adapter_keys_accounts_credential_reference_runtime_verifier_v1"


def verify_source_adapter_keys_accounts_credential_reference_runtime_package(package: Mapping[str, Any]) -> dict[str, Any]:
...
def main() -> None:
    print(json.dumps(verify_source_adapter_keys_accounts_credential_reference_runtime_package(example_keys_accounts_credential_reference_runtime_package()), indent=2, sort_keys=True))
