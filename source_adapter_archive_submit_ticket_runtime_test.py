...
package = example_source_adapter_archive_submit_ticket_runtime_package()
...
verification = verify_source_adapter_archive_submit_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter Archive Submit Ticket Runtime self-test passed.")
