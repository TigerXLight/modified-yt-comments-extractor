...
from source_adapter_total_export_package_receipt_runtime import build_default_record, build_record, render_record_text
from source_adapter_total_export_package_receipt_runtime_store import RuntimeStore
from source_adapter_total_export_package_receipt_runtime_verifier import verify_record, verify_records


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Total Export Package Receipt runtime helper")
    parser.add_argument("--runtime-id", default="total_export_package_receipt-cli")
...
def main(argv: list[str] | None = None) -> int:
    ...
    record = build_record(
        ...
        metadata={"runtime_title": "Total Export Package Receipt"},
    )
