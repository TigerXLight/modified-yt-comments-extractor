...
package = example_source_adapter_final_acceptance_packet_runtime_package()
...
verification = verify_source_adapter_final_acceptance_packet_runtime(package)
assert verification["verified"], verification
print("Source Adapter Final Acceptance Packet Runtime self-test passed.")
