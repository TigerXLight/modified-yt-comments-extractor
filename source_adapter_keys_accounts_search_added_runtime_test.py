from source_adapter_keys_accounts_search_added_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_keys_accounts_search_added_runtime_package
...
verification = verify_source_adapter_keys_accounts_search_added_runtime(package)
assert verification["verified"], verification
print("Source Adapter KEYS Accounts Search Added Runtime self-test passed.")
