...
package = example_source_adapter_x_archive_profile_executor_runtime_package()
...
verification = verify_source_adapter_x_archive_profile_executor_runtime(package)
assert verification["verified"], verification
print("Source Adapter X Archive Profile Executor Runtime self-test passed.")
