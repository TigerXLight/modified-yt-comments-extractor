...
verification = verify_source_adapter_evidence_release_acceptance_matrix_runtime(package)
assert verification["verified"], verification
print("Source Adapter Evidence Release Acceptance Matrix Runtime self-test passed.")
