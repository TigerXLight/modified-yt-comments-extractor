...
from source_adapter_archive_submit_execution_receipt_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Archive Submit Execution Receipt Runtime CLI self-test passed.")
