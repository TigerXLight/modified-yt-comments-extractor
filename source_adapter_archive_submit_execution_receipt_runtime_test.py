from source_adapter_archive_submit_execution_receipt_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "archive_submit_execution_receipt"
...
if __name__ == "__main__":
    ...
    print("Source Adapter Archive Submit Execution Receipt Runtime self-test passed.")
