...
from source_adapter_gui_total_export_acceptance_state_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter GUI Total Export Acceptance State Runtime CLI self-test passed.")
