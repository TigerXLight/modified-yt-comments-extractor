...
from source_adapter_release_final_integrity_check_runtime import RUNTIME_STAGE, ReleaseFinalIntegrityCheckRecord


def verify_record(record: ReleaseFinalIntegrityCheckRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[ReleaseFinalIntegrityCheckRecord]) -> list[str]:
    issues: list[str] = []
