...
package = example_source_adapter_source_observation_commit_ticket_runtime_package()
...
verification = verify_source_adapter_source_observation_commit_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter Source Observation Commit Ticket Runtime self-test passed.")
