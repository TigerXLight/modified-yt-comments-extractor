...
from source_adapter_gui_keys_accounts_acceptance_state_runtime import RUNTIME_STAGE, GuiKeysAccountsAcceptanceStateRecord


def verify_record(record: GuiKeysAccountsAcceptanceStateRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[GuiKeysAccountsAcceptanceStateRecord]) -> list[str]:
    issues: list[str] = []
