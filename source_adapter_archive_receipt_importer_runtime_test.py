from source_adapter_archive_receipt_importer_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_archive_receipt_importer_runtime_package
...
verification = verify_source_adapter_archive_receipt_importer_runtime(package)
assert verification["verified"], verification
print("Source Adapter Archive Receipt Importer Runtime self-test passed.")
