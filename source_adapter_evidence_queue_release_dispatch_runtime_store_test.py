from source_adapter_evidence_queue_release_dispatch_runtime import build_record
from source_adapter_evidence_queue_release_dispatch_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter Evidence Queue Release Dispatch Runtime store self-test passed.")
