...
from source_adapter_online_asr_receipt_import_bridge_runtime import RUNTIME_STAGE, OnlineAsrReceiptImportBridgeRecord


def verify_record(record: OnlineAsrReceiptImportBridgeRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[OnlineAsrReceiptImportBridgeRecord]) -> list[str]:
    issues: list[str] = []
