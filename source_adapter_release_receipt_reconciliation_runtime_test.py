...
package = example_source_adapter_release_receipt_reconciliation_runtime_package()
...
verification = verify_source_adapter_release_receipt_reconciliation_runtime(package)
assert verification["verified"], verification
print("Source Adapter Release Receipt Reconciliation Runtime self-test passed.")
