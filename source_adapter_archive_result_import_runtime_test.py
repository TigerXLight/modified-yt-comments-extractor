...
from source_adapter_archive_result_import_runtime import KEYS_ACCOUNTS_LABEL, STATUS, build_package


def test_archive_result_import_runtime() -> None:
...
if __name__ == "__main__":
    test_archive_result_import_runtime()
    print("Source Adapter Archive Result Import Runtime self-test passed.")
