...
from source_adapter_archive_submission_queue_runtime import KEYS_ACCOUNTS_LABEL, STATUS, build_package


def test_archive_submission_queue_runtime() -> None:
...
if __name__ == "__main__":
    test_archive_submission_queue_runtime()
    print("Source Adapter Archive Submission Queue Runtime self-test passed.")
