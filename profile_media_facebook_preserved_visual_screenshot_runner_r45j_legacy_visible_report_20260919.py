...
import profile_media_facebook_bounded_modal_capture_runner_r45h_legacy_visible_report_20260919 as r45h
...
def run_live(args: argparse.Namespace) -> Dict[str, Any]:
    ...
    with sync_playwright() as p:
        ...
        if args.auto_expand:
            ...
            try:
                print(f'R45AJ_VISIBLE_MISS_REPORT_AUTO_EXPAND_START max_seconds={args.expand_max_seconds}')
                auto_expand_summary = page.evaluate(r45h.JS_BOUNDED_MODAL_AUTO_EXPAND, opts)
                print('R45AJ_VISIBLE_MISS_REPORT_AUTO_EXPAND_DONE')
                try:
                    ...
                    print('R45AJ_VISIBLE_EXPAND_MISSED_REPORT ' + json.dumps({
