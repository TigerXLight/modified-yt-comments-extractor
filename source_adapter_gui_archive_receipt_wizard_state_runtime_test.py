...
verification = verify_source_adapter_gui_archive_receipt_wizard_state_runtime(package)
assert verification["verified"], verification
print("Source Adapter GUI Archive Receipt Wizard State Runtime self-test passed.")
