...
v = verify_source_adapter_browser_driver_binding_runtime_package(example_source_adapter_browser_driver_binding_runtime_package())
assert v["verified"], v
assert v["issue_count"] == 0, v
print("Source Adapter Browser Driver Binding Runtime verifier self-test passed.")
