...
from source_adapter_evidence_database_release_receipt_runtime import RUNTIME_STAGE, EvidenceDatabaseReleaseReceiptRecord


def verify_record(record: EvidenceDatabaseReleaseReceiptRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[EvidenceDatabaseReleaseReceiptRecord]) -> list[str]:
    issues: list[str] = []
