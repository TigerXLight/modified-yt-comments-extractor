...
from source_adapter_article_comment_bundle_receipt_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Article Comment Bundle Receipt Runtime CLI self-test passed.")
