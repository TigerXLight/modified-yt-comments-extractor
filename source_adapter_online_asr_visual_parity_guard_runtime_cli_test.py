...
from source_adapter_online_asr_visual_parity_guard_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Online ASR Visual Parity Guard Runtime CLI self-test passed.")
