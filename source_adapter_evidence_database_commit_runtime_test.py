from source_adapter_evidence_database_commit_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_evidence_database_commit_runtime_package
...
verification = verify_source_adapter_evidence_database_commit_runtime(package)
assert verification["verified"], verification
print("Source Adapter Evidence Database Commit Runtime self-test passed.")
