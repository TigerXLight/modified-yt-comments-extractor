...
from source_adapter_source_observation_finalizer_runtime import build_default_record, build_record, render_record_text
from source_adapter_source_observation_finalizer_runtime_store import RuntimeStore
from source_adapter_source_observation_finalizer_runtime_verifier import verify_record, verify_records


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Source Observation Finalizer runtime helper")
    parser.add_argument("--runtime-id", default="source_observation_finalizer-cli")
...
def main(argv: list[str] | None = None) -> int:
    ...
    record = build_record(
        ...
        metadata={"runtime_title": "Source Observation Finalizer"},
    )
