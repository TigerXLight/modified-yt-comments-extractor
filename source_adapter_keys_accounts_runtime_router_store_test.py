...
with tempfile.TemporaryDirectory() as tmp:
    result = store_source_adapter_keys_accounts_runtime_router_package(example_source_adapter_keys_accounts_runtime_router_package(), tmp)
...
print("Source Adapter KEYS Accounts Runtime Router store self-test passed.")
