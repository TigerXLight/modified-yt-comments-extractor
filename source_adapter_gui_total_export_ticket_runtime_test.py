...
package = example_source_adapter_gui_total_export_ticket_runtime_package()
...
verification = verify_source_adapter_gui_total_export_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter GUI Total Export Ticket Runtime self-test passed.")
