from source_adapter_secret_scope_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_secret_scope_runtime_package
...
verification = verify_source_adapter_secret_scope_runtime(package)
assert verification["verified"], verification
print("Source Adapter Secret Scope Runtime self-test passed.")
