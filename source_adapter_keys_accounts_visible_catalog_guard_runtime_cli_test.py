...
from source_adapter_keys_accounts_visible_catalog_guard_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter KEYS Accounts Visible Catalog Guard Runtime CLI self-test passed.")
