from source_adapter_absolute_delivery_acceptance_bundle_closeout_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "absolute_delivery_acceptance_bundle_closeout"
...
if __name__ == "__main__":
    ...
    print("Source Adapter Absolute Delivery Acceptance Bundle Closeout Runtime self-test passed.")
