...
ARCHIVE_PROVIDER_METADATA: tuple[ArchiveProviderMetadata, ...] = (
    ArchiveProviderMetadata(
        ...
        statuses=("FOUND", "NOT_FOUND_CONFIRMED", "MULTIPLE_FOUND", "NETWORK_ERROR"),
    ...
    ArchiveProviderMetadata(
        ...
        operations=(ARCHIVE_OPERATION_CHECK, ARCHIVE_OPERATION_SUBMIT),
        official_api=False,
        ...
        cache_ttl_seconds=3600,
        statuses=("FOUND", "NOT_FOUND_CONFIRMED", "CHALLENGE_REQUIRES_USER", "UNKNOWN"),
        limitations=("Challenge-prone service; automated live access remains separately gated.",),
    ),
    ArchiveProviderMetadata(
        provider_id=ARCHIVE_PROVIDER_ARCHIVEBOX,
        display_name="ArchiveBox",
        operations=(ARCHIVE_OPERATION_SUBMIT, ARCHIVE_OPERATION_POLL),
        official_api=False,
