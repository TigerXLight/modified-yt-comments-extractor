from source_adapter_evidence_item_release_commit_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "evidence_item_release_commit"
...
if __name__ == "__main__":
    ...
    print("Source Adapter Evidence Item Release Commit Runtime self-test passed.")
