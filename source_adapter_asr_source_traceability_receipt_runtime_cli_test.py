...
from source_adapter_asr_source_traceability_receipt_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter ASR Source Traceability Receipt Runtime CLI self-test passed.")
