...
package = example_source_adapter_keys_accounts_visible_state_ticket_runtime_package()
...
verification = verify_source_adapter_keys_accounts_visible_state_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter KEYS Accounts Visible State Ticket Runtime self-test passed.")
