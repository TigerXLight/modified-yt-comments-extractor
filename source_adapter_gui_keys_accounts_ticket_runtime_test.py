...
package = example_source_adapter_gui_keys_accounts_ticket_runtime_package()
...
verification = verify_source_adapter_gui_keys_accounts_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter GUI KEYS Accounts Ticket Runtime self-test passed.")
