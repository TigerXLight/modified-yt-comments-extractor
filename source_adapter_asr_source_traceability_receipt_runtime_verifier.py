...
from source_adapter_asr_source_traceability_receipt_runtime import RUNTIME_STAGE, AsrSourceTraceabilityReceiptRecord


def verify_record(record: AsrSourceTraceabilityReceiptRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[AsrSourceTraceabilityReceiptRecord]) -> list[str]:
    issues: list[str] = []
