from source_adapter_scroll_capture_controller_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_scroll_capture_controller_runtime_package
...
verification = verify_source_adapter_scroll_capture_controller_runtime(package)
assert verification["verified"], verification
print("Source Adapter Scroll Capture Controller Runtime self-test passed.")
