...
package = example_source_adapter_total_export_source_chapter_runtime_package()
...
verification = verify_source_adapter_total_export_source_chapter_runtime(package)
assert verification["verified"], verification
print("Source Adapter Total Export Source Chapter Runtime self-test passed.")
