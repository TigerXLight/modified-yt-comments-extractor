...
package = example_source_adapter_operator_live_run_preflight_runtime_package()
...
verification = verify_source_adapter_operator_live_run_preflight_runtime(package)
assert verification["verified"], verification
print("Source Adapter Operator Live Run Preflight Runtime self-test passed.")
