from source_adapter_gui_source_capture_command_bar_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_gui_source_capture_command_bar_runtime_package
...
verification = verify_source_adapter_gui_source_capture_command_bar_runtime(package)
assert verification["verified"], verification
print("Source Adapter GUI Source Capture Command Bar Runtime self-test passed.")
