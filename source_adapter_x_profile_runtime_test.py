from source_adapter_x_profile_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_x_profile_runtime_package
...
verification = verify_source_adapter_x_profile_runtime(package)
assert verification["verified"], verification
print("Source Adapter X Twitter Profile Runtime self-test passed.")
