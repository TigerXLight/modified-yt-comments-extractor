...
with tempfile.TemporaryDirectory() as tmp:
    result = store_source_adapter_provider_integration_bundle_closeout_package(example_source_adapter_provider_integration_bundle_closeout_package(), tmp)
...
print("Source Adapter Provider Integration Bundle Closeout store self-test passed.")
