...
from source_adapter_online_asr_provider_catalog_bridge_runtime import RUNTIME_STAGE, OnlineAsrProviderCatalogBridgeRecord


def verify_record(record: OnlineAsrProviderCatalogBridgeRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[OnlineAsrProviderCatalogBridgeRecord]) -> list[str]:
    issues: list[str] = []
