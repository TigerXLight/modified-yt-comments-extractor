...
from source_adapter_roadmap_coverage_acceptance_audit_runtime import build_default_record, build_record, render_record_text
from source_adapter_roadmap_coverage_acceptance_audit_runtime_store import RuntimeStore
from source_adapter_roadmap_coverage_acceptance_audit_runtime_verifier import verify_record, verify_records


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Roadmap Coverage Acceptance Audit runtime helper")
    parser.add_argument("--runtime-id", default="roadmap_coverage_acceptance_audit-cli")
...
def main(argv: list[str] | None = None) -> int:
    ...
    record = build_record(
        ...
        metadata={"runtime_title": "Roadmap Coverage Acceptance Audit"},
    )
