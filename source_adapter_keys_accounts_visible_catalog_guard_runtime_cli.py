...
from source_adapter_keys_accounts_visible_catalog_guard_runtime import build_default_record, build_record, render_record_text
from source_adapter_keys_accounts_visible_catalog_guard_runtime_store import RuntimeStore
from source_adapter_keys_accounts_visible_catalog_guard_runtime_verifier import verify_record, verify_records


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="KEYS Accounts Visible Catalog Guard runtime helper")
    parser.add_argument("--runtime-id", default="keys_accounts_visible_catalog_guard-cli")
...
def main(argv: list[str] | None = None) -> int:
    ...
    record = build_record(
        ...
        metadata={"runtime_title": "KEYS Accounts Visible Catalog Guard"},
    )
