...
package = example_source_adapter_provider_failure_ticket_runtime_package()
...
verification = verify_source_adapter_provider_failure_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter Provider Failure Ticket Runtime self-test passed.")
