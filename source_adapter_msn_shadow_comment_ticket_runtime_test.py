...
package = example_source_adapter_msn_shadow_comment_ticket_runtime_package()
...
verification = verify_source_adapter_msn_shadow_comment_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter MSN Shadow Comment Ticket Runtime self-test passed.")
