from source_adapter_end_to_end_receipt_auditor_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_end_to_end_receipt_auditor_runtime_package
...
verification = verify_source_adapter_end_to_end_receipt_auditor_runtime(package)
assert verification["verified"], verification
print("Source Adapter End-to-End Receipt Auditor Runtime self-test passed.")
