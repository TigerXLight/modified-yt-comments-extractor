...
from source_adapter_total_export_package_receipt_runtime import RUNTIME_STAGE, TotalExportPackageReceiptRecord


def verify_record(record: TotalExportPackageReceiptRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[TotalExportPackageReceiptRecord]) -> list[str]:
    issues: list[str] = []
