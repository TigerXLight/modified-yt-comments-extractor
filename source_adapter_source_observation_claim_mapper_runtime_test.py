from source_adapter_source_observation_claim_mapper_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_source_observation_claim_mapper_runtime_package
...
verification = verify_source_adapter_source_observation_claim_mapper_runtime(package)
assert verification["verified"], verification
print("Source Adapter Source Observation Claim Mapper Runtime self-test passed.")
