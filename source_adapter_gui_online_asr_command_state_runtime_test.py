...
verification = verify_source_adapter_gui_online_asr_command_state_runtime(package)
assert verification["verified"], verification
print("Source Adapter GUI Online ASR Command State Runtime self-test passed.")
