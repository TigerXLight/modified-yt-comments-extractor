from source_adapter_source_artifact_digest_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_source_artifact_digest_runtime_package
...
verification = verify_source_adapter_source_artifact_digest_runtime(package)
assert verification["verified"], verification
print("Source Adapter Source Artifact Digest Runtime self-test passed.")
