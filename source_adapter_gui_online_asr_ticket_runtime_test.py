...
package = example_source_adapter_gui_online_asr_ticket_runtime_package()
...
verification = verify_source_adapter_gui_online_asr_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter GUI Online ASR Ticket Runtime self-test passed.")
