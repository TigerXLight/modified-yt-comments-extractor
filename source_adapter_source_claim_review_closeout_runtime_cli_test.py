...
from source_adapter_source_claim_review_closeout_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Source Claim Review Closeout Runtime CLI self-test passed.")
