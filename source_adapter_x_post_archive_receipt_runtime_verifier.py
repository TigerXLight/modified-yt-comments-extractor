...
from source_adapter_x_post_archive_receipt_runtime import RUNTIME_STAGE, XPostArchiveReceiptRecord


def verify_record(record: XPostArchiveReceiptRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[XPostArchiveReceiptRecord]) -> list[str]:
    issues: list[str] = []
