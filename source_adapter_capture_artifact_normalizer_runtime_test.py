...
from source_adapter_capture_artifact_normalizer_runtime import KEYS_ACCOUNTS_LABEL, STATUS, build_package


def test_capture_artifact_normalizer_runtime() -> None:
...
if __name__ == "__main__":
    test_capture_artifact_normalizer_runtime()
    print("Source Adapter Capture Artifact Normalizer Runtime self-test passed.")
