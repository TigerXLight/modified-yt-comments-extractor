...
with tempfile.TemporaryDirectory() as tmp:
    result = store_source_adapter_operator_signoff_ticket_runtime_package(example_source_adapter_operator_signoff_ticket_runtime_package(), tmp)
...
print("Source Adapter Operator Signoff Ticket Runtime store self-test passed.")
