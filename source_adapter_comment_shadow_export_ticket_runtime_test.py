...
verification = verify_source_adapter_comment_shadow_export_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter Comment Shadow Export Ticket Runtime self-test passed.")
