from source_adapter_youtube_media_source_receipt_runtime import build_record
from source_adapter_youtube_media_source_receipt_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter YouTube Media Source Receipt Runtime store self-test passed.")
