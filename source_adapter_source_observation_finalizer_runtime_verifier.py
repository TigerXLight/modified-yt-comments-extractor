...
from source_adapter_source_observation_finalizer_runtime import RUNTIME_STAGE, SourceObservationFinalizerRecord


def verify_record(record: SourceObservationFinalizerRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[SourceObservationFinalizerRecord]) -> list[str]:
    issues: list[str] = []
