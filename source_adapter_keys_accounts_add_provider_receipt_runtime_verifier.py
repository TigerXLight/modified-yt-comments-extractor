...
from source_adapter_keys_accounts_add_provider_receipt_runtime import RUNTIME_STAGE, KeysAccountsAddProviderReceiptRecord


def verify_record(record: KeysAccountsAddProviderReceiptRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[KeysAccountsAddProviderReceiptRecord]) -> list[str]:
    issues: list[str] = []
