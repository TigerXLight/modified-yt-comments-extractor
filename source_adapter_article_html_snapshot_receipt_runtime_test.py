from source_adapter_article_html_snapshot_receipt_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "article_html_snapshot_receipt"
...
if __name__ == "__main__":
    ...
    print("Source Adapter Article HTML Snapshot Receipt Runtime self-test passed.")
