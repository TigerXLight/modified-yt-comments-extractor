from source_adapter_archive_manual_fallback_receipt_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "archive_manual_fallback_receipt"
...
if __name__ == "__main__":
    ...
    print("Source Adapter Archive Manual Fallback Receipt Runtime self-test passed.")
