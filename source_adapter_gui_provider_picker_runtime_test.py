from source_adapter_gui_provider_picker_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_gui_provider_picker_runtime_package
...
verification = verify_source_adapter_gui_provider_picker_runtime(package)
assert verification["verified"], verification
print("Source Adapter GUI Provider Picker Runtime self-test passed.")
