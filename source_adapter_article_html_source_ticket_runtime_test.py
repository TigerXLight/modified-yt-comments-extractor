...
package = example_source_adapter_article_html_source_ticket_runtime_package()
...
verification = verify_source_adapter_article_html_source_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter Article HTML Source Ticket Runtime self-test passed.")
