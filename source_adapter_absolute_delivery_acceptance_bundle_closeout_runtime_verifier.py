...
from source_adapter_absolute_delivery_acceptance_bundle_closeout_runtime import RUNTIME_STAGE, AbsoluteDeliveryAcceptanceBundleCloseoutRecord


def verify_record(record: AbsoluteDeliveryAcceptanceBundleCloseoutRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[AbsoluteDeliveryAcceptanceBundleCloseoutRecord]) -> list[str]:
    issues: list[str] = []
