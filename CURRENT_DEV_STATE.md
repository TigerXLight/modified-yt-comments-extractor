...
- Initial adapters:
  ...
  - Operational site-capture REV4 scaffolds:
    ...
    - REV4 full local regression/documentation closeout has passed for the operational capture fixture/model/UI/export metadata stack through Batch 6. Remaining REV4 work is MANUAL_LIVE_SITE_SMOKE_PENDING and separately approval-gated production hardening; no LIVE_SITE_MANUALLY_VERIFIED claim is made.
