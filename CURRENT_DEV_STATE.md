...
- Row 2C is now the first unresolved ordered layer and requires separate explicit security approval for secret-entry/save/clear/migration/reveal/copy behavior and legacy plaintext cleanup. Real connection/provider/network testing remains a later independently approved boundary.
