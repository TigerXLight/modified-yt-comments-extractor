...
from source_adapter_gui_online_asr_acceptance_state_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter GUI Online ASR Acceptance State Runtime CLI self-test passed.")
