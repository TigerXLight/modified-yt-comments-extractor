from source_adapter_comments_expansion_plan_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_comments_expansion_plan_runtime_package
...
verification = verify_source_adapter_comments_expansion_plan_runtime(package)
assert verification["verified"], verification
print("Source Adapter Comments Expansion Plan Runtime self-test passed.")
