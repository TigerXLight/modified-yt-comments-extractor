...
from source_adapter_archive_manual_fallback_receipt_runtime import RUNTIME_STAGE, ArchiveManualFallbackReceiptRecord


def verify_record(record: ArchiveManualFallbackReceiptRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[ArchiveManualFallbackReceiptRecord]) -> list[str]:
    issues: list[str] = []
