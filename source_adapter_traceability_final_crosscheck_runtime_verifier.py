...
from source_adapter_traceability_final_crosscheck_runtime import RUNTIME_STAGE, TraceabilityFinalCrosscheckRecord


def verify_record(record: TraceabilityFinalCrosscheckRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[TraceabilityFinalCrosscheckRecord]) -> list[str]:
    issues: list[str] = []
