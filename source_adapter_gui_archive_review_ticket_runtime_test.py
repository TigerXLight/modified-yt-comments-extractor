...
package = example_source_adapter_gui_archive_review_ticket_runtime_package()
...
verification = verify_source_adapter_gui_archive_review_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter GUI Archive Review Ticket Runtime self-test passed.")
