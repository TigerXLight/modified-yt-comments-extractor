from source_adapter_named_site_browser_binding_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_named_site_browser_binding_runtime_package
...
verification = verify_source_adapter_named_site_browser_binding_runtime(package)
assert verification["verified"], verification
print("Source Adapter Named-Site Browser Binding Runtime self-test passed.")
