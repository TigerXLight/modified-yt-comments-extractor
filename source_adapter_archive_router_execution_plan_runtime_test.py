...
package = example_source_adapter_archive_router_execution_plan_runtime_package()
...
verification = verify_source_adapter_archive_router_execution_plan_runtime(package)
assert verification["verified"], verification
print("Source Adapter Archive Router Execution Plan Runtime self-test passed.")
