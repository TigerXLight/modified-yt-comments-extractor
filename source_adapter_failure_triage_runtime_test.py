...
from source_adapter_failure_triage_runtime import KEYS_ACCOUNTS_LABEL, STATUS, build_package


def test_failure_triage_runtime() -> None:
...
if __name__ == "__main__":
    test_failure_triage_runtime()
    print("Source Adapter Failure Triage Runtime self-test passed.")
