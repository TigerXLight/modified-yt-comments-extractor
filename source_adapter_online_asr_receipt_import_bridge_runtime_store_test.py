from source_adapter_online_asr_receipt_import_bridge_runtime import build_record
from source_adapter_online_asr_receipt_import_bridge_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter Online ASR Receipt Import Bridge Runtime store self-test passed.")
