...
verification = verify_source_adapter_capture_comment_receipt_mapper_runtime(package)
assert verification["verified"], verification
print("Source Adapter Capture Comment Receipt Mapper Runtime self-test passed.")
