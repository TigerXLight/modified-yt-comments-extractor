from source_adapter_final_capture_command_registry_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "final_capture_command_registry"
...
if __name__ == "__main__":
    ...
    print("Source Adapter Final Capture Command Registry Runtime self-test passed.")
