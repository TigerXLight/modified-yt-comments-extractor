...
package = example_source_adapter_final_source_evidence_closeout_runtime_package()
...
verification = verify_source_adapter_final_source_evidence_closeout_runtime(package)
assert verification["verified"], verification
print("Source Adapter Final Source Evidence Closeout Runtime self-test passed.")
