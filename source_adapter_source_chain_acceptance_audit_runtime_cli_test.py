...
from source_adapter_source_chain_acceptance_audit_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Source Chain Acceptance Audit Runtime CLI self-test passed.")
