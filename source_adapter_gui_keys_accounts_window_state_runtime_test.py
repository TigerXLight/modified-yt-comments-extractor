...
verification = verify_source_adapter_gui_keys_accounts_window_state_runtime(package)
assert verification["verified"], verification
print("Source Adapter GUI KEYS Accounts Window State Runtime self-test passed.")
