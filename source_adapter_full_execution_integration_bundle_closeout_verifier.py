...
SCHEMA_VERSION = "source_adapter_full_execution_integration_bundle_closeout_verifier_v1"


def verify_source_adapter_full_execution_integration_bundle_closeout_package(package: Mapping[str, Any]) -> dict[str, Any]:
...
def main() -> None:
    print(json.dumps(verify_source_adapter_full_execution_integration_bundle_closeout_package(example_full_execution_integration_bundle_closeout_package()), indent=2, sort_keys=True))
