...
from source_adapter_evidence_queue_release_dispatch_runtime import build_default_record, build_record, render_record_text
from source_adapter_evidence_queue_release_dispatch_runtime_store import RuntimeStore
from source_adapter_evidence_queue_release_dispatch_runtime_verifier import verify_record, verify_records


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Evidence Queue Release Dispatch runtime helper")
    parser.add_argument("--runtime-id", default="evidence_queue_release_dispatch-cli")
...
def main(argv: list[str] | None = None) -> int:
    ...
    record = build_record(
        ...
        metadata={"runtime_title": "Evidence Queue Release Dispatch"},
    )
