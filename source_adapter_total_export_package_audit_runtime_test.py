...
package = example_source_adapter_total_export_package_audit_runtime_package()
...
verification = verify_source_adapter_total_export_package_audit_runtime(package)
assert verification["verified"], verification
print("Source Adapter Total Export Package Audit Runtime self-test passed.")
