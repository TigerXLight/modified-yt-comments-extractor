...
from source_adapter_source_claim_review_closeout_runtime import RUNTIME_STAGE, SourceClaimReviewCloseoutRecord


def verify_record(record: SourceClaimReviewCloseoutRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[SourceClaimReviewCloseoutRecord]) -> list[str]:
    issues: list[str] = []
