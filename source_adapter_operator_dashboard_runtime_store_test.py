...
with tempfile.TemporaryDirectory() as tmp:
    result = store_source_adapter_operator_dashboard_runtime_package(example_source_adapter_operator_dashboard_runtime_package(), tmp)
...
print("Source Adapter Operator Dashboard Runtime store self-test passed.")
