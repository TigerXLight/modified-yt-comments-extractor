from source_adapter_final_source_evidence_acceptance_pack_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "final_source_evidence_acceptance_pack"
...
if __name__ == "__main__":
    ...
    print("Source Adapter Final Source Evidence Acceptance Pack Runtime self-test passed.")
