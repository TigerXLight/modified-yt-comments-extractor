from source_adapter_release_bundle_storage_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_release_bundle_storage_runtime_package
...
verification = verify_source_adapter_release_bundle_storage_runtime(package)
assert verification["verified"], verification
print("Source Adapter Release Bundle Storage Runtime self-test passed.")
