from source_adapter_online_asr_visual_parity_guard_runtime import build_record
from source_adapter_online_asr_visual_parity_guard_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter Online ASR Visual Parity Guard Runtime store self-test passed.")
