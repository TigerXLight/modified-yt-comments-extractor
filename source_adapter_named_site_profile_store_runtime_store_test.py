...
with tempfile.TemporaryDirectory() as tmp:
    result = store_source_adapter_named_site_profile_store_runtime_package(example_source_adapter_named_site_profile_store_runtime_package(), tmp)
...
print("Source Adapter Named-Site Profile Store Runtime store self-test passed.")
