...
from source_adapter_operator_approval_packet_runtime import KEYS_ACCOUNTS_LABEL, STATUS, build_package


def test_operator_approval_packet_runtime() -> None:
...
if __name__ == "__main__":
    test_operator_approval_packet_runtime()
    print("Source Adapter Operator Approval Packet Runtime self-test passed.")
