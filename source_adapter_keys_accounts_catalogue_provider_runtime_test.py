...
package = example_source_adapter_keys_accounts_catalogue_provider_runtime_package()
...
verification = verify_source_adapter_keys_accounts_catalogue_provider_runtime(package)
assert verification["verified"], verification
print("Source Adapter KEYS Accounts Catalogue Provider Runtime self-test passed.")
