from source_adapter_total_export_commit_runner_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_total_export_commit_runner_runtime_package
...
verification = verify_source_adapter_total_export_commit_runner_runtime(package)
assert verification["verified"], verification
print("Source Adapter Total Export Commit Runner Runtime self-test passed.")
