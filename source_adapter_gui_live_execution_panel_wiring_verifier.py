...
SCHEMA_VERSION = "source_adapter_gui_live_execution_panel_wiring_verifier_v1"


def verify_source_adapter_gui_live_execution_panel_wiring_package(package: Mapping[str, Any]) -> dict[str, Any]:
...
def main() -> None:
    print(json.dumps(verify_source_adapter_gui_live_execution_panel_wiring_package(example_gui_live_execution_panel_wiring_package()), indent=2, sort_keys=True))
