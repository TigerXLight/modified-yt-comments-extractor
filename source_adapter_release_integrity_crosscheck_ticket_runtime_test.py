...
package = example_source_adapter_release_integrity_crosscheck_ticket_runtime_package()
...
verification = verify_source_adapter_release_integrity_crosscheck_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter Release Integrity Crosscheck Ticket Runtime self-test passed.")
