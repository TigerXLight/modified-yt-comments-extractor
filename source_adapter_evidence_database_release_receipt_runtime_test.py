from source_adapter_evidence_database_release_receipt_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "evidence_database_release_receipt"
...
if __name__ == "__main__":
    ...
    print("Source Adapter Evidence Database Release Receipt Runtime self-test passed.")
