from source_adapter_gui_online_asr_acceptance_state_runtime import build_record
from source_adapter_gui_online_asr_acceptance_state_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter GUI Online ASR Acceptance State Runtime store self-test passed.")
