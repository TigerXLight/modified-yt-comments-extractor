...
verification = verify_source_adapter_archive_manual_receipt_validator_runtime(package)
assert verification["verified"], verification
print("Source Adapter Archive Manual Receipt Validator Runtime self-test passed.")
