...
from source_adapter_total_export_package_receipt_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Total Export Package Receipt Runtime CLI self-test passed.")
