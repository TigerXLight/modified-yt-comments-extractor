...
from source_adapter_source_claim_review_closeout_runtime import build_default_record, build_record, render_record_text
from source_adapter_source_claim_review_closeout_runtime_store import RuntimeStore
from source_adapter_source_claim_review_closeout_runtime_verifier import verify_record, verify_records


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Source Claim Review Closeout runtime helper")
    parser.add_argument("--runtime-id", default="source_claim_review_closeout-cli")
...
def main(argv: list[str] | None = None) -> int:
    ...
    record = build_record(
        ...
        metadata={"runtime_title": "Source Claim Review Closeout"},
    )
