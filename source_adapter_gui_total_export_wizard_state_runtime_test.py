...
verification = verify_source_adapter_gui_total_export_wizard_state_runtime(package)
assert verification["verified"], verification
print("Source Adapter GUI Total Export Wizard State Runtime self-test passed.")
