# Source Adapter Local ASR Large V3 Vulkan Profile Runtime

This slice records the **Local ASR Large V3 Vulkan Profile** stage for the shared Source Adapter / Total Export / Source Evidence roadmap.
...
- a stable runtime stage identifier: `local_asr_large_v3_vulkan_profile`;
