# Source Adapter GUI Online ASR Acceptance State Runtime

This slice records the **GUI Online ASR Acceptance State** stage for the shared Source Adapter / Total Export / Source Evidence roadmap.
...
- a stable runtime stage identifier: `gui_online_asr_acceptance_state`;
