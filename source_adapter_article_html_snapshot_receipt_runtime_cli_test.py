...
from source_adapter_article_html_snapshot_receipt_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Article HTML Snapshot Receipt Runtime CLI self-test passed.")
