...
package = example_source_adapter_final_runtime_index_runtime_package()
...
verification = verify_source_adapter_final_runtime_index_runtime(package)
assert verification["verified"], verification
print("Source Adapter Final Runtime Index Runtime self-test passed.")
