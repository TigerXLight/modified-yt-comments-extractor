...
from source_adapter_final_operator_master_packet_runtime import build_default_record, build_record, render_record_text
from source_adapter_final_operator_master_packet_runtime_store import RuntimeStore
from source_adapter_final_operator_master_packet_runtime_verifier import verify_record, verify_records


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Final Operator Master Packet runtime helper")
    parser.add_argument("--runtime-id", default="final_operator_master_packet-cli")
...
def main(argv: list[str] | None = None) -> int:
    ...
    record = build_record(
        ...
        metadata={"runtime_title": "Final Operator Master Packet"},
    )
