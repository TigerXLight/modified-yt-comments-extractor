from source_adapter_keys_accounts_visible_catalog_guard_runtime import build_record
from source_adapter_keys_accounts_visible_catalog_guard_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter KEYS Accounts Visible Catalog Guard Runtime store self-test passed.")
