...
package = example_source_adapter_readiness_crosscheck_ticket_runtime_package()
...
verification = verify_source_adapter_readiness_crosscheck_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter Readiness Crosscheck Ticket Runtime self-test passed.")
