...
from source_adapter_provider_receipt_persistence_runtime import STATUS, HANDOFF_STATUS, example_source_adapter_provider_receipt_persistence_runtime_package

SCHEMA_VERSION = "source_adapter_provider_receipt_persistence_runtime_verifier_v1"


def verify_source_adapter_provider_receipt_persistence_runtime_package(package: Mapping[str, Any]) -> dict[str, Any]:
    ...
    if int(package.get("issue_count", 0)) != 0:
        issues.append({"issue_id": "package_reported_issues", "severity": "error", "count": package.get("issue_count")})
...
if __name__ == "__main__":
    print(json.dumps(verify_source_adapter_provider_receipt_persistence_runtime_package(example_source_adapter_provider_receipt_persistence_runtime_package()), indent=2, sort_keys=True))
