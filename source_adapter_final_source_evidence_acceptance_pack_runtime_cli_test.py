...
from source_adapter_final_source_evidence_acceptance_pack_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Final Source Evidence Acceptance Pack Runtime CLI self-test passed.")
