...
def test_database_sidebar_section_is_mode_on_off_only() -> None:
    source = _main_source()
...
if __name__ == "__main__":
    test_database_sidebar_section_is_mode_on_off_only()
    test_database_sidebar_mode_setter_does_not_update_preview_or_status_widgets()
    print("profile_media_database_sidebar_mode_only v75l OK")
