from source_adapter_evidence_source_linking_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_evidence_source_linking_runtime_package
...
verification = verify_source_adapter_evidence_source_linking_runtime(package)
assert verification["verified"], verification
print("Source Adapter Evidence Source Linking Runtime self-test passed.")
