from source_adapter_operator_receipt_import_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_operator_receipt_import_runtime_package
...
verification = verify_source_adapter_operator_receipt_import_runtime(package)
assert verification["verified"], verification
print("Source Adapter Operator Receipt Import Runtime self-test passed.")
