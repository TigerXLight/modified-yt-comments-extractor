...
from source_adapter_release_operator_signoff_receipt_runtime import build_default_record, build_record, render_record_text
from source_adapter_release_operator_signoff_receipt_runtime_store import RuntimeStore
from source_adapter_release_operator_signoff_receipt_runtime_verifier import verify_record, verify_records


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Release Operator Signoff Receipt runtime helper")
    parser.add_argument("--runtime-id", default="release_operator_signoff_receipt-cli")
...
def main(argv: list[str] | None = None) -> int:
    ...
    record = build_record(
        ...
        metadata={"runtime_title": "Release Operator Signoff Receipt"},
    )
