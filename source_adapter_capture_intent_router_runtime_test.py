from source_adapter_capture_intent_router_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_capture_intent_router_runtime_package
...
verification = verify_source_adapter_capture_intent_router_runtime(package)
assert verification["verified"], verification
print("Source Adapter Capture Intent Router Runtime self-test passed.")
