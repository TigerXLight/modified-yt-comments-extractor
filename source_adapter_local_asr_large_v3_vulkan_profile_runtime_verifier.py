...
from source_adapter_local_asr_large_v3_vulkan_profile_runtime import RUNTIME_STAGE, LocalAsrLargeV3VulkanProfileRecord


def verify_record(record: LocalAsrLargeV3VulkanProfileRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[LocalAsrLargeV3VulkanProfileRecord]) -> list[str]:
    issues: list[str] = []
