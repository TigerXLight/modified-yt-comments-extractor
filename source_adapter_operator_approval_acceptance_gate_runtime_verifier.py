...
from source_adapter_operator_approval_acceptance_gate_runtime import RUNTIME_STAGE, OperatorApprovalAcceptanceGateRecord


def verify_record(record: OperatorApprovalAcceptanceGateRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[OperatorApprovalAcceptanceGateRecord]) -> list[str]:
    issues: list[str] = []
