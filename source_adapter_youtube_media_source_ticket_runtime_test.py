...
verification = verify_source_adapter_youtube_media_source_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter YouTube Media Source Ticket Runtime self-test passed.")
