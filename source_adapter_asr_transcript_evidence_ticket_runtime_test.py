...
package = example_source_adapter_asr_transcript_evidence_ticket_runtime_package()
...
verification = verify_source_adapter_asr_transcript_evidence_ticket_runtime(package)
assert verification["verified"], verification
print("Source Adapter ASR Transcript Evidence Ticket Runtime self-test passed.")
