...
verification = verify_source_adapter_operator_live_run_receipt_import_runtime(package)
assert verification["verified"], verification
print("Source Adapter Operator Live Run Receipt Import Runtime self-test passed.")
