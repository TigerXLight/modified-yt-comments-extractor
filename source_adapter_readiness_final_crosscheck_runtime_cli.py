...
from source_adapter_readiness_final_crosscheck_runtime import build_default_record, build_record, render_record_text
from source_adapter_readiness_final_crosscheck_runtime_store import RuntimeStore
from source_adapter_readiness_final_crosscheck_runtime_verifier import verify_record, verify_records


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Readiness Final Crosscheck runtime helper")
    parser.add_argument("--runtime-id", default="readiness_final_crosscheck-cli")
...
def main(argv: list[str] | None = None) -> int:
    ...
    record = build_record(
        ...
        metadata={"runtime_title": "Readiness Final Crosscheck"},
    )
