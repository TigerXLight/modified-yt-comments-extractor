from source_adapter_archive_polling_outcome_receipt_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "archive_polling_outcome_receipt"
...
if __name__ == "__main__":
    ...
    print("Source Adapter Archive Polling Outcome Receipt Runtime self-test passed.")
