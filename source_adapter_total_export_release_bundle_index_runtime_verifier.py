...
from source_adapter_total_export_release_bundle_index_runtime import RUNTIME_STAGE, TotalExportReleaseBundleIndexRecord


def verify_record(record: TotalExportReleaseBundleIndexRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[TotalExportReleaseBundleIndexRecord]) -> list[str]:
    issues: list[str] = []
