...
from source_adapter_release_operator_signoff_receipt_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Release Operator Signoff Receipt Runtime CLI self-test passed.")
