from source_adapter_evidence_item_release_commit_runtime import build_record
from source_adapter_evidence_item_release_commit_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter Evidence Item Release Commit Runtime store self-test passed.")
