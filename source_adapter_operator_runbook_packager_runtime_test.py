from source_adapter_operator_runbook_packager_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_operator_runbook_packager_runtime_package
...
verification = verify_source_adapter_operator_runbook_packager_runtime(package)
assert verification["verified"], verification
print("Source Adapter Operator Runbook Packager Runtime self-test passed.")
