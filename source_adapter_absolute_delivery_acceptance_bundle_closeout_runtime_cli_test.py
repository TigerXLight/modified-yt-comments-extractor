...
from source_adapter_absolute_delivery_acceptance_bundle_closeout_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Absolute Delivery Acceptance Bundle Closeout Runtime CLI self-test passed.")
