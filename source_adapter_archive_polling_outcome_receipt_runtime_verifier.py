...
from source_adapter_archive_polling_outcome_receipt_runtime import RUNTIME_STAGE, ArchivePollingOutcomeReceiptRecord


def verify_record(record: ArchivePollingOutcomeReceiptRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[ArchivePollingOutcomeReceiptRecord]) -> list[str]:
    issues: list[str] = []
