...
SCHEMA_VERSION = "source_adapter_release_file_delivery_backend_verifier_v1"


def verify_source_adapter_release_file_delivery_backend_package(package: Mapping[str, Any]) -> dict[str, Any]:
...
def main() -> None:
    print(json.dumps(verify_source_adapter_release_file_delivery_backend_package(example_release_file_delivery_backend_package()), indent=2, sort_keys=True))
