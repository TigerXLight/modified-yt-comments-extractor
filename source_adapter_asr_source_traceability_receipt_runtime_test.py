from source_adapter_asr_source_traceability_receipt_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "asr_source_traceability_receipt"
...
if __name__ == "__main__":
    ...
    print("Source Adapter ASR Source Traceability Receipt Runtime self-test passed.")
