...
SCHEMA_VERSION = "source_adapter_production_runtime_bundle_closeout_verifier_v1"


def verify_source_adapter_production_runtime_bundle_closeout_package(package: Mapping[str, Any]) -> dict[str, Any]:
...
if __name__ == "__main__":
    print(json.dumps(verify_source_adapter_production_runtime_bundle_closeout_package(example_source_adapter_production_runtime_bundle_closeout_package()), indent=2, sort_keys=True))
