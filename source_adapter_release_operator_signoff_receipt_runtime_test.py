from source_adapter_release_operator_signoff_receipt_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "release_operator_signoff_receipt"
...
if __name__ == "__main__":
    ...
    print("Source Adapter Release Operator Signoff Receipt Runtime self-test passed.")
