...
with tempfile.TemporaryDirectory() as tmp:
    result = store_source_adapter_evidence_sync_runtime_package(example_source_adapter_evidence_sync_runtime_package(), tmp)
...
print("Source Adapter Evidence Sync Runtime store self-test passed.")
