...
verification = verify_source_adapter_total_export_source_indexer_runtime(package)
assert verification["verified"], verification
print("Source Adapter Total Export Source Indexer Runtime self-test passed.")
