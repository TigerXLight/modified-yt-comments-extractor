from source_adapter_archive_poll_result_merge_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_archive_poll_result_merge_runtime_package
...
verification = verify_source_adapter_archive_poll_result_merge_runtime(package)
assert verification["verified"], verification
print("Source Adapter Archive Poll Result Merge Runtime self-test passed.")
