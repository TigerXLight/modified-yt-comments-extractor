...
from source_adapter_archive_submit_execution_receipt_runtime import RUNTIME_STAGE, ArchiveSubmitExecutionReceiptRecord


def verify_record(record: ArchiveSubmitExecutionReceiptRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[ArchiveSubmitExecutionReceiptRecord]) -> list[str]:
    issues: list[str] = []
