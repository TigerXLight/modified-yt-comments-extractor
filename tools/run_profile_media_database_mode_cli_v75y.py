...
from profile_media_database_mode import database_mode_payload, build_database_mode_view_from_batch_json_files  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build a UI-neutral Profile/Media Database mode main-panel view from explicit case batch JSON files.")
    ...
    parser.add_argument("--print-view", action="store_true", help="Include a human-readable Database mode view.")
    ...
    view = build_database_mode_view_from_batch_json_files(
        batch_paths,
    ...
    output = database_mode_payload(view, include_text=args.print_view)
