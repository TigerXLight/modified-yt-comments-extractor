# R42BQ Process Structure

R42BQ keeps the R42BO native toolbar behaviour but fixes the layout: the toolbar and WebView2 are hosted in a two-row native TableLayoutPanel, so the YTCE controls cannot overlay the rendered page or Wayback capture banner.
