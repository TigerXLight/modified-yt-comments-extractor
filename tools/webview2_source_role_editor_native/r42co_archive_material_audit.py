...
def main() -> int:
    ...
    out=Path.home()/'Downloads'/f'r42co_archive_material_audit_{stamp}.txt'
    lines=[]
    lines.append('===== R42CO ARCHIVE MATERIAL AUDIT =====')
    lines.append(f'Root: {ROOT}')
    lines.append(f'Target: {TARGET}')
    lines.append(f'LOCALAPPDATA: {os.environ.get("LOCALAPPDATA","")}')
    check_dirs=[
        ROOT/'profile_media_live_captures'/'r42co_archive_source_material',
