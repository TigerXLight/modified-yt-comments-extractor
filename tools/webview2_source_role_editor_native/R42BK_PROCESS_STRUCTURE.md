# R42BK native WebView2 source-role editor structure

R42BK keeps the R42BI database-maintenance checkpoint and adds in-window source URL navigation.
...
- Maintenance/VACUUM is manual/off-path via `maintain_r42bk_source_role_db.cmd`.
