# R42BZ native WebView2 source-role editor patch

R42BZ builds on R42BX.
...
R42BZ compile fix: NativeToolbarIconButton public properties now use System.ComponentModel serialization metadata so WinForms WFO1000 analyzer does not fail the build.
