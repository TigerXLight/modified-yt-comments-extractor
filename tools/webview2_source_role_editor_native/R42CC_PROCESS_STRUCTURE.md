# R42CC Native WebView2 source-role editor patch

R42CC is based on the working R42BZ code path and keeps the true native toolbar above the WebView2 rectangle.
