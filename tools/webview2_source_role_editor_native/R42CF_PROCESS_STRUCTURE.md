# R42CF Native WebView2 Source Role Editor
...
R42CF adds human-chain source navigation: Original/Wayback/archive.ph rows from the same user TXT/link intake batch stay visible in the native toolbar even when an archive row is unchecked, challenge-blocked, or not evidence-ready. The archive target is navigation-only until article/source markers pass.
