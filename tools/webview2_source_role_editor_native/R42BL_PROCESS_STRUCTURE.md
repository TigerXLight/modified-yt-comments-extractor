# R42BL native WebView2 source-role editor structure

R42BL keeps the R42BI database-maintenance checkpoint and adds in-window source URL navigation.
...
- Maintenance/VACUUM is manual/off-path via `maintain_r42bl_source_role_db.cmd`.
...
## R42BL archive-safe toolbar dock
