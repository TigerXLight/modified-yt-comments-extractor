...
py -3 "%~dp0r42bq_source_role_db.py" maintain --db "%DB%" --keep-sessions-per-url 25 --keep-events 5000 --vacuum
if errorlevel 1 python "%~dp0r42bq_source_role_db.py" maintain --db "%DB%" --keep-sessions-per-url 25 --keep-events 5000 --vacuum
endlocal
