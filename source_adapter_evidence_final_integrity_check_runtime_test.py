from source_adapter_evidence_final_integrity_check_runtime import build_default_record, build_record, read_record, summarise_record, write_record
import tempfile
...
def test_default_record_summary():
    ...
    assert summary["stage"] == "evidence_final_integrity_check"
...
if __name__ == "__main__":
    ...
    print("Source Adapter Evidence Final Integrity Check Runtime self-test passed.")
