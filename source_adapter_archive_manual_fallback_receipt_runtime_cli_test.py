...
from source_adapter_archive_manual_fallback_receipt_runtime_cli import main
...
if __name__ == "__main__":
    ...
    print("Source Adapter Archive Manual Fallback Receipt Runtime CLI self-test passed.")
