from source_adapter_account_provider_state_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_account_provider_state_runtime_package
...
verification = verify_source_adapter_account_provider_state_runtime(package)
assert verification["verified"], verification
print("Source Adapter Account Provider State Runtime self-test passed.")
