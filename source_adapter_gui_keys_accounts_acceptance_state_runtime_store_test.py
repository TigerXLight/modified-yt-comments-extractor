...
from source_adapter_gui_keys_accounts_acceptance_state_runtime_store import RuntimeStore, read_records, write_records
import tempfile
...
if __name__ == "__main__":
    ...
    print("Source Adapter GUI KEYS Accounts Acceptance State Runtime store self-test passed.")
