from source_adapter_failure_recovery_plan_runtime import HANDOFF_STATUS, KEYS_ACCOUNTS_LABEL, ROW_KEY, STATUS, example_source_adapter_failure_recovery_plan_runtime_package
...
verification = verify_source_adapter_failure_recovery_plan_runtime(package)
assert verification["verified"], verification
print("Source Adapter Failure Recovery Plan Runtime self-test passed.")
