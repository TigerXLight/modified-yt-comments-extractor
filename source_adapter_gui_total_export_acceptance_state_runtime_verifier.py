...
from source_adapter_gui_total_export_acceptance_state_runtime import RUNTIME_STAGE, GuiTotalExportAcceptanceStateRecord


def verify_record(record: GuiTotalExportAcceptanceStateRecord) -> list[str]:
    issues: list[str] = []
...
def verify_records(records: Iterable[GuiTotalExportAcceptanceStateRecord]) -> list[str]:
    issues: list[str] = []
